  ...
  [3852],
  {
    ...
    5748: (e, t, i) => {
        ...
        requestUpdate(e, t, i, r = !1, s) {
          if (void 0 !== e) {
            ...
            if (
              (!1 === r && (s = this[e]),
              !(
                ((i ??= a.getPropertyOptions(e)).hasChanged ?? C)(s, t) ||
                (i.useDefault &&
                  i.reflect &&
                  s === this._$Ej?.get(e) &&
      ...
      (N.elementStyles = []),
        ...
        (N.finalized = new Map()),
        v?.({ ReactiveElement: N }),
        (w.reactiveElementVersions ??= []).push("2.1.2");
    },
    7106: (e, t, i) => {
      "use strict";
      i.d(t, { A: () => u, X: () => g });
   ...
   `;
    ...
    43852: (e, t, i) => {
      ...
      async function e_({ hash: e, signature: t }) {
        let r = B(e) ? e : J(e),
          { secp256k1: s } = await i.e(6382).then(i.bind(i, 96382)),
          a = (() => {
      ...
      var eF = Object.defineProperty,
        ...
        eX = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        eY = (e, t) => {
          for (var i in t || (t = {})) eG.call(t, i) && eX(e, i, t[i]);
          if (eK) for (var i of eK(t)) eJ.call(t, i) && eX(e, i, t[i]);
          return e;
        };
      let eZ = {
      ...
      function e1() {
        return !eQ() && !!(0, D.getNavigator)() && !!(0, D.getDocument)();
      }
      function e2() {
        return e0()
          ? eZ.reactNative
      ...
      function e7(e = k.FIVE_MINUTES, t) {
        let i,
          r,
          s,
          a,
          ...
          let c = (function (e, t, i) {
              ...
              if (e.startsWith("https://t.me")) {
                ...
                s = `${s}${t}${(function (e, t = !1) {
                  let i = ej.from(e).toString("base64");
      ...
      async function tc(e, t) {
        let i = "";
        try {
          if (e1() && (i = localStorage.getItem(t))) return i;
          i = await e.getItem(t);
        } catch (e) {
          console.error(e);
        }
      ...
      let tI = 68 === new Uint8Array(new Uint32Array([0x11223344]).buffer)[0];
      function tN(e) {
      ...
      let tO = [],
        ...
        t$ = BigInt(256),
        tL = BigInt(113);
      for (let e = 0, t = tR, i = 1, r = 0; e < 24; e++) {
        ([i, r] = [r, (2 * i + 3 * r) % 5]),
          tO.push(2 * (5 * r + i)),
          tT.push((((e + 1) * (e + 2)) / 2) % 64);
        let s = tx;
        for (let e = 0; e < 7; e++)
          (t = ((t << tR) ^ ((t >> tD) * tL)) % t$) & tU &&
            (s ^= tR << ((tR << BigInt(e)) - tR));
      ...
      let [tM, tW] = (function (e, t = !1) {
          let i = new Uint32Array(e.length),
            r = new Uint32Array(e.length);
          for (let s = 0; s < e.length; s++) {
            let { h: a, l: n } = (function (e, t = !1) {
              return t
                ? { h: Number(e & ty), l: Number((e >> tb) & ty) }
                : { h: 0 | Number((e >> tb) & ty), l: 0 | Number(e & ty) };
            })(e[s], t);
            [i[s], r[s]] = [a, n];
          }
          return [i, r];
      ...
      class tq extends t_ {
        ...
        xof(e) {
          return tp(e), this.xofInto(new Uint8Array(e));
        }
        digestInto(e) {
          if ((tw(e, this), this.finished))
            throw Error("digest() was already called");
          return this.writeInto(e), this.destroy(), e;
        }
        digest() {
      ...
      let tH = tS(() => new tq(136, 1, 32));
      function tF(e) {
        let t = `Ethereum Signed Message:
${e.length}`,
          i = new TextEncoder().encode(t + e);
        return "0x" + ej.from(tH(i)).toString("hex");
      }
      async function tz(e, t, i, r, s, a) {
        switch (i.t) {
          case "eip191":
            return await tV(e, t, i.s);
          case "eip1271":
            return await tK(e, t, i.s, r, s, a);
          default:
            throw Error(
      ...
      async function tV(e, t, i) {
        return (
          (await eP({ hash: tF(t), signature: i })).toLowerCase() ===
          e.toLowerCase()
        );
      }
      async function tK(e, t, i, r, s, a) {
        let n = eq(r);
      ...
      async function t3(e) {
        let { cacao: t, projectId: i } = e,
          ...
          a = t8(s, s.iss),
          n = t5(s.iss);
        return await tz(n, a, r, t2(s.iss), i);
      }
      let t8 = (e, t) => {
...
`)
      ...
      function t9(e) {
        ...
        let i =
          ...
          JSON.parse(ej.from(t, "base64").toString("utf-8")));
        return t6(i), i;
      }
      function t7(e) {
        var t;
      ...
      let ig = (e) => Uint8Array.from(e.split("").map((e) => e.charCodeAt(0))),
        im = ig("expand 16-byte k"),
        iw = ig("expand 32-byte k"),
        iy = ic(im),
        ib = ic(iw);
      function iv(e, t) {
        return (e << t) | (e >>> (32 - t));
      ...
      let iC = 0x100000000 - 1,
        iI = new Uint32Array(),
        iN = (e, t) => (255 & e[t++]) | ((255 & e[t++]) << 8);
      class iA {
        constructor(e) {
          (this.blockLen = 16),
            (this.outputLen = 16),
          ...
          (this.r[0] = 8191 & t),
            ...
            (this.r[9] = (c >>> 5) & 127);
          for (let t = 0; t < 8; t++) this.pad[t] = iN(e, 16 + 2 * t);
        }
        process(e, t, i = !1) {
          let { h: r, r: s } = this,
            a = s[0],
          ...
          (R = $ >>> 13),
            ...
            (R += $ >>> 13),
            ($ &= 8191);
          let L = R + I * c + N * o + A * n + _ * a + 5 * g * S;
          (R = L >>> 13),
            (L &= 8191),
            (L += 5 * p * P + 5 * u * O + 5 * d * T + 5 * h * k + 5 * l * x),
            (R += L >>> 13),
            (L &= 8191);
          let M = R + I * l + N * c + A * o + _ * n + S * a;
          (R = M >>> 13),
            (M &= 8191),
            (M += 5 * g * P + 5 * p * O + 5 * u * T + 5 * d * k + 5 * h * x),
            (R += M >>> 13),
            (M &= 8191);
        ...
        destroy() {
          ip(this.h, this.r, this.buffer, this.pad);
        }
        digestInto(e) {
          ia(this),
            (function (e, t) {
      ...
      let i_ = (function (e) {
          let t = (t, i) => e(i).update(il(t)).digest(),
        ...
        iS = (function (e, t) {
          ...
          return (
            ...
            (t, o, c, l, h = 0) => {
              ...
              if (r) {
                ...
                r(f, m, ic(o.subarray(0, 16)), m), (o = o.subarray(16));
              }
              let w = 16 - s;
              if (w !== o.length)
          ...
          function (e, t, i, r, s, a = 20) {
            let n = e[0],
              ...
              $ = v;
            for (let e = 0; e < a; e += 2)
              (O = (O + (R = iv(R ^ (E = (E + A) | 0), 16))) | 0),
                (E = (E + (A = iv(A ^ O, 12))) | 0),
                (O = (O + (R = iv(R ^ E, 8))) | 0),
                (A = iv(A ^ O, 7)),
                (T = (T + (U = iv(U ^ (C = (C + _) | 0), 16))) | 0),
                (C = (C + (_ = iv(_ ^ T, 12))) | 0),
                (T = (T + (U = iv(U ^ C, 8))) | 0),
                (_ = iv(_ ^ T, 7)),
                (k = (k + (D = iv(D ^ (I = (I + S) | 0), 16))) | 0),
                (I = (I + (S = iv(S ^ k, 12))) | 0),
                (k = (k + (D = iv(D ^ I, 8))) | 0),
                (S = iv(S ^ k, 7)),
                (x = (x + ($ = iv($ ^ (N = (N + P) | 0), 16))) | 0),
                ...
                (k = (k + ($ = iv($ ^ E, 8))) | 0),
                (_ = iv(_ ^ k, 7)),
                (x = (x + (R = iv(R ^ (C = (C + S) | 0), 16))) | 0),
                (C = (C + (S = iv(S ^ x, 12))) | 0),
                (x = (x + (R = iv(R ^ C, 8))) | 0),
                (S = iv(S ^ x, 7)),
                (O = (O + (U = iv(U ^ (I = (I + P) | 0), 16))) | 0),
                (I = (I + (P = iv(P ^ O, 12))) | 0),
                (O = (O + (U = iv(U ^ I, 8))) | 0),
                (P = iv(P ^ O, 7)),
                (T = (T + (D = iv(D ^ (N = (N + A) | 0), 16))) | 0),
                (N = (N + (A = iv(A ^ T, 12))) | 0),
                (T = (T + (D = iv(D ^ N, 8))) | 0),
                (A = iv(A ^ T, 7));
            let L = 0;
      ...
      function ik(e, t, i, r, s) {
        ...
        id(c, 0, BigInt(s ? s.length : 0), !0),
          id(c, 8, BigInt(r.length), !0),
          n.update(o);
        let l = n.digest();
        return ip(a, o), l;
      }
      let ix = ((e, t) => {
        function i(r, ...s) {
          if ((is(r), void 0 !== e.nonceLength)) {
            let t = s[0];
            if (!t) throw Error("nonce / iv required");
            e.varSizeNonce ? is(t) : is(t, e.nonceLength);
          }
          let a = e.tagLength;
          a && void 0 !== s[1] && is(s[1]);
          let n = t(r, ...s),
          ...
          return {
            encrypt(e, t) {
              ...
              return (c = !0), is(e), o(n.encrypt.length, t), n.encrypt(e, t);
            },
            decrypt(e, t) {
              if ((is(e), a && e.length < a))
                throw Error(
        ...
        ((e) => (t, i, r) => ({
          encrypt(s, a) {
            ...
            e(t, i, o, o, 1);
            let c = ik(e, t, i, o, r);
            return a.set(c, n), ip(c), a;
          },
          decrypt(s, a) {
            a = ih(s.length - 16, a, !1);
            ...
            return a.set(s.subarray(0, -16)), e(t, i, a, a, 1), ip(c), a;
          },
        }))(iS)
      );
      class iR extends t_ {
        constructor(e, t) {
          super(), (this.finished = !1), (this.destroyed = !1), tf(e);
          let i = tA(t);
          if (
        ...
        update(e) {
          return tm(this), this.iHash.update(e), this;
        }
        digestInto(e) {
          tm(this),
            tg(e, this.outputLen),
      ...
      let iU = (e, t, i) => new iR(e, t).update(i).digest();
      iU.create = (e, t) => new iR(e, t);
      ...
      class iL extends t_ {
        ...
        digestInto(e) {
          tm(this), tw(e, this), (this.finished = !0);
      ...
      class ij extends iL {
        ...
        process(e, t) {
          for (let i = 0; i < 16; i++, t += 4) iB[i] = e.getUint32(t, !1);
          for (let e = 16; e < 64; e++) {
            let t = iB[e - 15],
              i = iB[e - 2],
              r = tC(t, 7) ^ tC(t, 18) ^ (t >>> 3),
              s = tC(i, 17) ^ tC(i, 19) ^ (i >>> 10);
            iB[e] = (s + iB[e - 7] + r + iB[e - 16]) | 0;
          }
          ...
          for (let e = 0; e < 64; e++) {
            ...
            let t =
                (l +
                  (tC(n, 6) ^ tC(n, 11) ^ tC(n, 25)) +
                  (((h = n) & o) ^ (~h & c)) +
                  iM[e] +
                  iB[e]) |
                0,
              g =
                ((tC(i, 2) ^ tC(i, 13) ^ tC(i, 22)) +
                  (((d = i) & (u = r)) ^ (d & (p = s)) ^ (u & p))) |
                0;
            (l = c),
              (c = o),
      ...
      function iZ(e) {
        ...
        return "" === e ? iH : BigInt("0x" + e);
      }
      let iQ = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function i0(e) {
        return e >= iQ._0 && e <= iQ._9
          ? e - iQ._0
          : e >= iQ.A && e <= iQ.F
          ? e - (iQ.A - 10)
          : e >= iQ.a && e <= iQ.f
      ...
      function i1(e) {
        ...
        for (let t = 0, s = 0; t < i; t++, s += 2) {
          let i = i0(e.charCodeAt(s)),
            a = i0(e.charCodeAt(s + 1));
      ...
      function i5(e) {
        return iK(e), iZ(iX(Uint8Array.from(e).reverse()));
      }
      function i3(e, t) {
        return i1(e.toString(16).padStart(2 * t, "0"));
      }
      function i8(e, t) {
        return i3(e, t).reverse();
      }
      function i6(e, t, i) {
        let r;
        if ("string" == typeof t)
      ...
      let i9 = (e) => "bigint" == typeof e && iH <= e;
      function i7(e, t, i) {
        return i9(e) && i9(t) && i9(i) && t <= e && e < i;
      }
      function re(e, t, i, r) {
        if (!i7(t, i, r))
          throw Error(
      ...
      function rt(e) {
        let t;
        for (t = 0; e > iH; e >>= iF, t += 1);
        return t;
      }
      let ri = (e) => (iz << BigInt(e - 1)) - iF,
        rr = (e) => new Uint8Array(e),
        rs = (e) => Uint8Array.from(e);
      function ra(e, t, i) {
      ...
      let rn = {
        ...
        stringOrUint8Array: (e) => "string" == typeof e || iV(e),
      ...
      var rl = Object.freeze({
        ...
        bitLen: rt,
        bitGet: function (e, t) {
          return (e >> BigInt(t)) & iF;
        },
        bitSet: function (e, t, i) {
          return e | ((i ? iF : iH) << BigInt(t));
        },
        bitMask: ri,
        createHmacDrbg: ra,
        validateObject: ro,
      ...
      function ry(e, t, i) {
        if (t < rh) throw Error("invalid exponent, negatives unsupported");
        if (i <= rh) throw Error("invalid modulus");
        if (i === rd) return rh;
        let r = rd;
        for (; t > rh; )
          t & rd && (r = (r * e) % i), (e = (e * e) % i), (t >>= rd);
        return r;
      }
      function rb(e, t, i) {
        let r = e;
      ...
      function rv(e, t) {
        if (e === rh) throw Error("invert: expected non-zero number");
        if (t <= rh) throw Error("invert: expected positive modulus, got " + t);
        let i = rw(e, t),
          r = t,
          s = rh,
          a = rd;
        ...
        if (r !== rd) throw Error("invert: does not exist");
        return rw(s, t);
      }
      let rE = [
        "create",
      ...
      function rI(e, t, i = !1, r = {}) {
        let s;
        if (e <= rh) throw Error("invalid field: expected ORDER > 0, got " + e);
        let { nBitLength: a, nByteLength: n } = rC(e, t);
        if (n > 2048)
        ...
        let o = Object.freeze({
          ...
          pow: (e, t) =>
            (function (e, t, i) {
              ...
              if (i === rh) return e.ONE;
              if (i === rd) return t;
              let r = e.ONE,
                s = t;
              for (; i > rh; )
                i & rd && (r = e.mul(r, s)), (s = e.sqr(s)), (i >>= rd);
              return r;
            })(o, e, t),
          div: (t, i) => rw(t * rv(i, e), e),
          sqrN: (e) => e * e,
          addN: (e, t) => e + t,
          subN: (e, t) => e - t,
          mulN: (e, t) => e * t,
                ...
                (s = (function (e) {
                  ...
                  return (function (e) {
                    let t,
                      ...
                      r,
                      s = (e - rd) / ru;
                    for (t = e - rd, i = 0; t % ru === rh; t /= ru, i++);
                    for (r = ru; r < e && ry(r, s, e) !== e - rd; r++)
                      if (r > 1e3)
                        throw Error(
      ...
      function rT(e, t) {
        return (
          rO(e, t), { windows: Math.ceil(t / e) + 1, windowSize: 2 ** (e - 1) }
        );
      }
      let rk = new WeakMap(),
        rx = new WeakMap();
      ...
      function rU(e) {
        return (
          ...
          Object.freeze({ ...rC(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
        );
      }
      ...
      let rq = (function (e) {
        let t =
          ...
          c = t.powPminus2 || ((e) => ry(e, i - BigInt(2), i));
        function l(e, t, i) {
          let s = r(e * (t - i));
        ...
        function d(e, t) {
          let d = (function (e, t) {
            ...
            (function (e) {
              let t = i6("u coordinate", e, a);
              return 32 === n && (t[31] &= 127), i5(t);
            })(t),
            (function (e) {
              let t = i6("scalar", e),
                i = t.length;
          ...
          if (d === rD) throw Error("invalid private or public key received");
          return i8(r(d), a);
        }
        let u = i8(r(t.Gu), a);
        function p(e) {
        ...
        powPminus2: (e) => {
          let { pow_p_5_8: t, b2: i } = (function (e) {
            let t = BigInt(10),
              ...
              p = (rb(u, s, rL) * d) % rL,
              g = (rb(p, t, rL) * c) % rL;
            return { pow_p_5_8: (rb(g, rW, rL) * e) % rL, b2: a };
          })(e);
          return rw(rb(t, rB, rL) * i, rL);
        },
      ...
      function rH(e) {
        void 0 !== e.lowS && iG("lowS", e.lowS),
          void 0 !== e.prehash && iG("prehash", e.prehash);
      }
      let { bytesToNumberBE: rF, hexToBytes: rz } = rl;
      ...
      let rK = {
          ...
          toSig(e) {
            let { Err: t, _int: i, _tlv: r } = rK,
              s = "string" == typeof e ? rz(e) : e;
            iK(s);
            ...
            (function (e) {
              ...
              let {
                  ...
                  function c(e) {
                    ...
                    try {
                      t =
                        "bigint" == typeof e ? e : i2(i6("private key", e, s));
                    } catch {
                      throw Error(
                    ...
                    return a && (t = rw(t, n)), re("private key", t, rJ, n), t;
                  }
                  function l(e) {
                    if (!(e instanceof u))
                  ...
                  class u {
                    ...
                    static fromHex(e) {
                      let t = u.fromAffine(n(i6("pointHex", e)));
                    ...
                    toHex(e = !0) {
                      return iG("isCompressed", e), iX(this.toRawBytes(e));
                    }
                  }
                    ...
                    g =
                      ((t = i.endo ? Math.ceil(p / 2) : p),
                      {
                        ...
                        precomputeWindow(e, i) {
                          let { windows: r, windowSize: s } = rT(i, t),
                            a = [],
                            n = e,
                            o = n;
                          for (let e = 0; e < r; e++) {
                        ...
                        wNAF(e, i, r) {
                          let { windows: s, windowSize: a } = rT(e, t),
                            n = u.ZERO,
                            o = u.BASE,
                            c = BigInt(2 ** e - 1),
                            l = 2 ** e,
                        ...
                        wNAFUnsafe(e, i, r, s = u.ZERO) {
                          let { windows: a, windowSize: n } = rT(e, t),
                            o = BigInt(2 ** e - 1),
                            c = 2 ** e,
                            l = BigInt(e);
                          for (let e = 0; e < a; e++) {
                  ...
                  toBytes(e, t, r) {
                    ...
                    return (
                      iG("isCompressed", r),
                      r
                        ? i4(Uint8Array.from([t.hasEvenY() ? 2 : 3]), a)
                        : i4(Uint8Array.from([4]), a, i.toBytes(s.y))
                    );
                  },
                  fromBytes(e) {
                    let t = e.length,
                ...
                d = (e) => iX(i3(e, t.nByteLength)),
                u = (e, t, i) => i2(e.slice(t, i));
              class p {
                constructor(e, t, i) {
                  (this.r = e),
                    (this.s = t),
                ...
                static fromCompact(e) {
                  let i = t.nByteLength;
                  return new p(
                    u((e = i6("compactSignature", e, 2 * i)), 0, i),
                    u(e, i, 2 * i)
                  );
                }
                static fromDER(e) {
                  let { r: t, s: i } = rK.toSig(i6("DER", e));
                  return new p(t, i);
                }
                assertValidity() {
                  re("r", this.r, rJ, r), re("s", this.s, rJ, r);
                }
                addRecoveryBit(e) {
                ...
                toDERRawBytes() {
                  return i1(this.toDERHex());
                }
                toDERHex() {
                  return rK.hexFromSig({ r: this.r, s: this.s });
                }
                toCompactRawBytes() {
                  return i1(this.toCompactHex());
                }
                toCompactHex() {
              ...
              function y(e) {
                return (
                  re("num < 2^" + t.nBitLength, e, rG, w), i3(e, t.nByteLength)
                );
              }
                  ...
                  sign: function (e, s, a = b) {
                    let { seed: l, k2sig: d } = (function (e, s, a = b) {
                      ...
                      null == u && (u = !0),
                        (e = i6("msgHash", e)),
                        rH(a),
                        g && (e = i6("prehashed msgHash", l(e)));
                      let v = m(e),
                        E = c(s),
                        C = [y(E), y(v)];
                      if (null != w && !1 !== w) {
                        let e = !0 === w ? d(i.BYTES) : w;
                        C.push(i6("extraEntropy", e));
                      }
                      return {
                        seed: i4(...C),
                        k2sig: function (e) {
                  ...
                  utils: {
                    ...
                    randomPrivateKey: () => {
                      ...
                      return (function (e, t, i = !1) {
                        ...
                        let n = rw(i ? i5(e) : i2(e), t - rd) + rd;
                        return i ? i8(n, s) : i3(n, s);
                      })(t.randomBytes(e), t.n);
                    },
      ...
      function r8(e) {
        return eM(iq(eL(e, r0)), r0);
      }
      function r6(e) {
        return eM(iq(eL(e, r5)), r0);
      }
      function r4(e) {
        return Number(eM(e, rQ));
      }
      function r9(e) {
      ...
      function se(e) {
        if (2 === r4(e.type)) return eM(ek([e.type, e.sealed]), r1);
        if (1 === r4(e.type)) {
          if (typeof e.senderPublicKey > "u")
            throw Error("Missing sender public key for type 1 envelope");
          return eM(ek([e.type, e.senderPublicKey, e.iv, e.sealed]), r1);
        }
        return eM(ek([e.type, e.iv, e.sealed]), r1);
      }
      function st(e) {
        let t = eL((e.encoding || r1) === r2 ? r7(e.encoded) : e.encoded, r1),
          i = t.slice(0, 1);
        if (1 === r4(i)) {
          let e = t.slice(1, 33),
            r = t.slice(33, 45);
        ...
        if (2 === r4(i)) return { type: i, sealed: t.slice(1), iv: tP(12) };
        let r = t.slice(1, 13);
      ...
      var sl = Object.defineProperty,
        ...
        sf = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        sm = (e, t) => {
          for (var i in t || (t = {})) sp.call(t, i) && sf(e, i, t[i]);
          if (su) for (var i of su(t)) sg.call(t, i) && sf(e, i, t[i]);
          return e;
        },
        sw = (e, t) => sh(e, sd(t));
      function sy(e) {
      ...
      function sE(e) {
        ...
        for (let [a, n] of Object.entries(e)) {
          let e = sb(a) ? [a] : n.chains,
            o = n.methods || [],
            c = n.events || [],
            l = sv(a);
          s[l] = sw(sm({}, s[l]), {
            chains: tn(e, null == (t = s[l]) ? void 0 : t.chains),
            methods: tn(o, null == (i = s[l]) ? void 0 : i.methods),
            events: tn(c, null == (r = s[l]) ? void 0 : r.events),
          });
        }
        return s;
      }
      function sC(e, t) {
        ...
        for (let [t, r] of Object.entries(i))
          r.methods ? (r.methods = tn(r.methods, e)) : (r.methods = e),
      ...
      function sT(e, t) {
        return !!(t && sO(e)) || ("string" == typeof e && !!e.trim().length);
      }
      function sk(e, t) {
        return !!(t && sO(e)) || ("number" == typeof e && !isNaN(e));
      }
      function sx(e) {
        return !!(sT(e, !1) && e.includes(":")) && 2 === e.split(":").length;
      }
      function sR(e) {
        let t = !0;
        return (
          sS(e) ? e.length && (t = e.every((e) => sT(e, !1))) : (t = !1), t
        );
      }
      function sU(e, t) {
        let i = null;
      ...
      Approved: ${o.toString()}`
        ...
        Approved: ${s.toString()}`
          ...
          n.forEach((e) => {
            r ||
              (e6(s[e].methods, a[e].methods)
                ? e6(s[e].events, a[e].events) ||
                  (r = sA(
                    "NON_CONFORMING_NAMESPACES",
      ...
      async function sq() {
        if (e0() && "u" > typeof i.g && null != i.g && i.g.NetInfo) {
      ...
      let sX = "core",
        ...
        sZ = { logger: "error" },
        sQ = { database: ":memory:" },
        s0 = "client_ed25519_seed",
        s1 = k.ONE_DAY,
        s2 = k.SIX_HOURS,
        s5 = "wss://relay.walletconnect.org",
        s3 = {
        ...
        s6 = "2.21.0",
        s4 = { link_mode: "link_mode", relay: "relay" },
        s9 = { inbound: "inbound", outbound: "outbound" },
        s7 = "WALLETCONNECT_LINK_MODE_APPS",
        ae = {
        ...
        aa = "https://verify.walletconnect.org",
        an = `${aa}/v3`,
        ao = ["https://verify.walletconnect.com", aa],
        ac = {
      ...
      class av {
        constructor(e, t, i, r) {
          (this.name = e),
            ...
            (this.baseEncode = i),
            (this.baseDecode = r),
            (this.encoder = new am(e, t, i)),
            (this.decoder = new aw(e, t, r));
        }
        encode(e) {
      ...
      let aE = ({ name: e, prefix: t, encode: i, decode: r }) =>
          new av(e, t, i, r),
        aC = ({ prefix: e, name: t, alphabet: i }) => {
          let { encode: r, decode: s } = ag(i, t);
          return aE({ prefix: e, name: t, encode: r, decode: (e) => af(s(e)) });
        },
        aI = ({ name: e, prefix: t, bitsPerChar: i, alphabet: r }) =>
          aE({
            prefix: t,
            name: e,
            encode: (e) =>
      ...
      var aN = Object.freeze({
        ...
        aS = Object.freeze({
          __proto__: null,
          base10: aC({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        }),
        aP = Object.freeze({
          __proto__: null,
          base16: aI({
      ...
      let aq = Array.from(
        ...
        aH = aq.reduce((e, t, i) => ((e[i] = t), e), []),
        aF = aq.reduce((e, t, i) => ((e[t.codePointAt(0)] = i), e), []);
      var az = Object.freeze({
        ...
        base256emoji: aE({
          ...
          name: "base256emoji",
          encode: function (e) {
            return e.reduce((e, t) => (e += aH[t]), "");
          },
          decode: function (e) {
            let t = [];
            for (let i of e) {
              let e = aF[i.codePointAt(0)];
      ...
      function aV(e, t, i) {
        ...
        return (t[i] = 0 | e), (aV.bytes = i - r + 1), t;
      }
      var aK = {
        encode: aV,
      ...
      let aG = (e, t, i = 0) => (aK.encode(e, t, i), t),
        aJ = (e) => aK.encodingLength(e),
        aX = (e, t) => {
          let i = t.byteLength,
            r = aJ(e),
            s = r + aJ(i),
            a = new Uint8Array(s + i);
          return aG(e, a, 0), aG(i, a, r), a.set(t, s), new aY(e, i, t, a);
        };
      class aY {
        constructor(e, t, i, r) {
      ...
      let aZ = ({ name: e, code: t, encode: i }) => new aQ(e, t, i);
      class aQ {
        constructor(e, t, i) {
      ...
      var a1 = Object.freeze({
          __proto__: null,
          sha256: aZ({ name: "sha2-256", code: 18, encode: a0("SHA-256") }),
          sha512: aZ({ name: "sha2-512", code: 19, encode: a0("SHA-512") }),
        }),
        a2 = Object.freeze({
          __proto__: null,
          identity: {
      ...
      class ne {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            a7(this, "keychain", new Map()),
            a7(this, "name", "keychain"),
            a7(this, "version", "0.3"),
            a7(this, "initialized", !1),
            a7(this, "storagePrefix", sY),
            a7(this, "init", async () => {
              if (!this.initialized) {
        ...
        async setKeyChain(e) {
          await this.core.storage.setItem(this.storageKey, e4(e));
        }
        async getKeyChain() {
          let e = await this.core.storage.getItem(this.storageKey);
          return "u" > typeof e ? e9(e) : void 0;
        }
        async persist() {
      ...
      class nr {
        constructor(e, t, i) {
          (this.core = e),
            ...
            ni(this, "name", "crypto"),
            ni(this, "keychain"),
            ni(this, "randomSessionIdentifier", r3()),
            ni(this, "initialized", !1),
            ni(this, "init", async () => {
              this.initialized ||
            ...
            ni(this, "getClientId", async () => {
              this.isInitialized();
              let e = await this.getClientSeed(),
                t = R.TZ(e);
              return R.UF(t.publicKey);
            }),
            ni(this, "generateKeyPair", () => {
              this.isInitialized();
              let e = (function () {
                let e = rq.utils.randomPrivateKey(),
                  t = rq.getPublicKey(e);
                return { privateKey: eM(e, r0), publicKey: eM(t, r0) };
              })();
              return this.setPrivateKey(e.publicKey, e.privateKey);
            }),
            ni(this, "signJWT", async (e) => {
              this.isInitialized();
              let t = await this.getClientSeed(),
                i = R.TZ(t),
                r = this.randomSessionIdentifier;
              return await R.FA(r, e, s1, i);
            }),
            ni(this, "generateSharedKey", (e, t, i) => {
              this.isInitialized();
              let r = (function (e, t) {
                var i;
                let r,
                  s = rq.getSharedSecret(eL(e, r0), eL(t, r0));
                return eM(
                  ((r = void 0),
                  (function (e, t, i, r = 32) {
                    if ((tf(e), tp(r), r > 255 * e.outputLen))
                    ...
                    ((i = void 0),
                    tf(iq),
                    void 0 === i && (i = new Uint8Array(iq.outputLen)),
                    iU(iq, tA(i), tA(s))),
                    r,
                    32
                  )),
            ...
            ni(this, "setSymKey", async (e, t) => {
              this.isInitialized();
              let i = t || r8(e);
              return await this.keychain.set(i, e), i;
            }),
            ni(this, "deleteKeyPair", async (e) => {
              this.isInitialized(), await this.keychain.del(e);
            }),
            ni(this, "deleteSymKey", async (e) => {
              this.isInitialized(), await this.keychain.del(e);
            }),
            ni(this, "encode", async (e, t, i) => {
              this.isInitialized();
              let r = si(i),
                s = (0, x.h)(t);
              if (2 === r.type)
                return (function (e, t) {
                  let i = eL("2", rQ),
                    r = tP(12),
                    s = se({ type: i, sealed: eL(e, r5), iv: r });
                  return t === r2 ? r9(s) : s;
                })(s, i?.encoding);
              if (sr(r)) {
              ...
              return (function (e) {
                var t;
                let i =
                  ((t = "u" > typeof e.type ? e.type : 0), eL(`${t}`, rQ));
                if (1 === r4(i) && typeof e.senderPublicKey > "u")
                  throw Error("Missing sender public key for type 1 envelope");
                let r =
                    "u" > typeof e.senderPublicKey
                      ? eL(e.senderPublicKey, r0)
                      : void 0,
                  s = "u" > typeof e.iv ? eL(e.iv, r0) : tP(12),
                  a = se({
                    type: i,
                    sealed: ix(eL(e.symKey, r0), s).encrypt(eL(e.message, r5)),
                    iv: s,
                    senderPublicKey: r,
                  });
                return e.encoding === r2 ? r9(a) : a;
              })({
                type: n,
                symKey: a,
                message: s,
            ...
            ni(this, "getPayloadType", (e, t = r1) =>
              r4(st({ encoded: e, encoding: t }).type)
            ),
            ni(this, "getPayloadSenderPublicKey", (e, t = r1) => {
              let i = st({ encoded: e, encoding: t });
              return i.senderPublicKey ? eM(i.senderPublicKey, r0) : void 0;
            }),
            (this.core = e),
            (this.logger = (0, d.U5)(t, this.name)),
            (this.keychain = i || new ne(this.core, this.logger));
        }
        get context() {
          return (0, d.oI)(this.logger);
        }
        ...
        async getClientSeed() {
          let e = "";
          try {
            e = this.keychain.get(s0);
          } catch {
            (e = r3()), await this.keychain.set(s0, e);
          }
      ...
      var ns = Object.defineProperty,
        ...
        nh = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        nd = (e, t, i) => nh(e, "symbol" != typeof t ? t + "" : t, i);
      class nu extends y {
        constructor(e, t) {
          super(e, t),
            (this.logger = e),
            (this.core = t),
            nd(this, "messages", new Map()),
            nd(this, "messagesWithoutClientAck", new Map()),
            nd(this, "name", "messages"),
            nd(this, "version", "0.3"),
            nd(this, "initialized", !1),
            nd(this, "storagePrefix", sY),
            nd(this, "init", async () => {
              if (!this.initialized) {
            ...
            nd(this, "set", async (e, t, i) => {
              this.isInitialized();
              let r = r6(t),
                s = this.messages.get(e);
              if ((typeof s > "u" && (s = {}), "u" > typeof s[r])) return r;
              if (((s[r] = t), this.messages.set(e, s), i === s9.inbound)) {
                ...
                this.messagesWithoutClientAck.set(
                  ...
                  na(
                    ((e, t) => {
                      for (var i in t || (t = {}))
                        nc.call(t, i) && nh(e, i, t[i]);
                      if (no)
                        for (var i of no(t)) nl.call(t, i) && nh(e, i, t[i]);
                      return e;
                    })({}, i),
                    nn({ [r]: t })
                  )
            ...
            nd(
              this,
              "has",
              (e, t) => (this.isInitialized(), "u" > typeof this.get(e)[r6(t)])
            ),
            nd(this, "ack", async (e, t) => {
              this.isInitialized();
              let i = this.messagesWithoutClientAck.get(e);
      ...
      var np = Object.defineProperty,
        ...
        nb = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        nv = (e, t) => {
          for (var i in t || (t = {})) nw.call(t, i) && nb(e, i, t[i]);
          if (nm) for (var i of nm(t)) ny.call(t, i) && nb(e, i, t[i]);
          return e;
        },
        nE = (e, t) => ng(e, nf(t)),
        nC = (e, t, i) => nb(e, "symbol" != typeof t ? t + "" : t, i);
      class nI extends b {
        constructor(e, t) {
          super(e, t),
            (this.relayer = e),
            (this.logger = t),
            nC(this, "events", new o.EventEmitter()),
            nC(this, "name", "publisher"),
            nC(this, "queue", new Map()),
            nC(this, "publishTimeout", (0, k.toMiliseconds)(k.ONE_MINUTE)),
            nC(
              this,
            ...
            nC(this, "publish", async (e, t, i) => {
              ...
              let s = i?.ttl || s2,
                ...
                n = i?.prompt || !1,
                o = i?.tag || 0,
                c = i?.id || (0, sV.getBigIntRpcId)().toString(),
                l = {
                  topic: e,
                  message: t,
                  opts: {
              ...
              try {
                let r = new Promise(async (r) => {
                  let a = ({ id: e }) => {
                    l.opts.id === e &&
                      ...
                      this.relayer.events.removeListener(s3.publish, a),
                      r(l));
                  };
                  this.relayer.events.on(s3.publish, a);
                  let h = te(
                    new Promise((r, a) => {
                      this.rpcPublish({
                        topic: e,
                  ...
                  try {
                    await h, this.events.removeListener(s3.publish, a);
                  } catch (e) {
                    this.queue.set(c, nE(nv({}, l), { attempt: 1 })),
                ...
                this.logger.trace({
                  ...
                  await te(r, this.publishTimeout, h);
              } catch (e) {
                if (
        ...
        async rpcPublish(e) {
          ...
          sO(null == (t = p.params) ? void 0 : t.prompt) &&
            (null == (i = p.params) || delete i.prompt),
            sO(null == (r = p.params) ? void 0 : r.tag) &&
          ...
          return (
            this.relayer.events.emit(s3.publish, e),
        ...
        checkQueue() {
          this.queue.forEach(async (e, t) => {
            let i = e.attempt + 1;
            this.queue.set(t, nE(nv({}, e), { attempt: i }));
          ...
          this.relayer.core.heartbeat.on(l.li.pulse, () => {
            if (this.needsTransportRestart) {
              (this.needsTransportRestart = !1),
                this.relayer.events.emit(s3.connection_stalled);
              return;
            }
            this.checkQueue();
          }),
            this.relayer.on(s3.message_ack, (e) => {
      ...
      class n_ {
        constructor() {
          nA(this, "map", new Map()),
            ...
            nA(this, "get", (e) => this.map.get(e) || []),
            nA(this, "exists", (e, t) => this.get(e).includes(t)),
            nA(this, "delete", (e, t) => {
      ...
      var nS = Object.defineProperty,
        ...
        nR = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        nU = (e, t) => {
          for (var i in t || (t = {})) nk.call(t, i) && nR(e, i, t[i]);
          if (nT) for (var i of nT(t)) nx.call(t, i) && nR(e, i, t[i]);
          return e;
        },
        nD = (e, t) => nP(e, nO(t)),
        n$ = (e, t, i) => nR(e, "symbol" != typeof t ? t + "" : t, i);
      class nL extends C {
        constructor(e, t) {
          super(e, t),
            (this.relayer = e),
            (this.logger = t),
            n$(this, "subscriptions", new Map()),
            n$(this, "topicMap", new n_()),
            n$(this, "events", new o.EventEmitter()),
            n$(this, "name", "subscription"),
            n$(this, "version", "0.3"),
            n$(this, "pending", new Map()),
            n$(this, "cached", []),
            n$(this, "initialized", !1),
            n$(this, "storagePrefix", sY),
            n$(this, "subscribeTimeout", (0, k.toMiliseconds)(k.ONE_MINUTE)),
            n$(
              this,
            ...
            n$(this, "clientId"),
            n$(this, "batchSubscribeTopicsLimit", 500),
            n$(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                this.registerEventListeners(),
            ...
            n$(this, "restart", async () => {
              await this.restore(), await this.onRestart();
            }),
            n$(this, "checkPending", async () => {
              if (
                0 === this.pending.size &&
        ...
        async unsubscribeById(e, t, i) {
          ...
          try {
            ...
            let s = s_("USER_DISCONNECTED", `${this.name}, ${e}`);
        ...
        async rpcSubscribe(e, t, i) {
          var r;
          (i && i?.transportType !== s4.relay) ||
            (await this.restartToComplete({ topic: e, id: e, relay: t }));
          let s = { method: sa(t.protocol).subscribe, params: { topic: e } };
          this.logger.debug("Outgoing Relay Payload"),
            this.logger.trace({
              type: "payload",
              direction: "outgoing",
          ...
          try {
            ...
            if (i?.transportType === s4.link_mode)
              return (
                setTimeout(() => {
            ...
            let r = new Promise(async (t) => {
                let i = (r) => {
                  r.topic === e &&
                    (this.events.removeListener(ae.created, i), t(r.id));
                };
                this.events.on(ae.created, i);
                try {
                  let r = await te(
                    new Promise((e, t) => {
                      this.relayer
                  ...
                  this.events.removeListener(ae.created, i), t(r);
                } catch {}
              }),
              n = await te(
                r,
        ...
        async rpcBatchSubscribe(e) {
          if (!e.length) return;
          let t = {
            method: sa(e[0].relay.protocol).batchSubscribe,
        ...
        async rpcBatchFetchMessages(e) {
          ...
          if (!e.length) return;
          let i = {
            method: sa(e[0].relay.protocol).batchFetchMessages,
            params: { topics: e.map((e) => e.topic) },
          };
          this.logger.debug("Outgoing Relay Payload"),
            this.logger.trace({
        ...
        rpcUnsubscribe(e, t, i) {
          let r = {
            method: sa(i.protocol).unsubscribe,
            params: { topic: e, id: t },
          };
          return (
            this.logger.debug("Outgoing Relay Payload"),
        ...
        onSubscribe(e, t) {
          this.setSubscription(e, nD(nU({}, t), { id: e })),
            this.pending.delete(t.topic);
        }
        onBatchSubscribe(e) {
          e.length &&
            e.forEach((e) => {
              this.setSubscription(e.id, nU({}, e)),
        ...
        addSubscription(e, t) {
          this.subscriptions.set(e, nU({}, t)),
            this.topicMap.set(t.topic, e),
            this.events.emit(ae.created, t);
        }
        getSubscription(e) {
        ...
        deleteSubscription(e, t) {
          ...
          this.subscriptions.delete(e),
            ...
            this.events.emit(ae.deleted, nD(nU({}, i), { reason: t }));
        }
        async persist() {
          await this.setRelayerSubscriptions(this.values),
            this.events.emit(ae.sync);
        }
        async onRestart() {
        ...
        async batchSubscribe(e) {
          e.length &&
            ...
            this.onBatchSubscribe(
              await Promise.all(
                e.map(async (e) =>
                  nD(nU({}, e), { id: await this.getSubscriptionId(e.topic) })
                )
              )
            ));
        }
        ...
        async getSubscriptionId(e) {
          return r6(e + (await this.getClientId()));
        }
      }
      var nM = Object.defineProperty,
        ...
        nq = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        nH = (e, t) => {
          for (var i in t || (t = {})) nB.call(t, i) && nq(e, i, t[i]);
          if (nW) for (var i of nW(t)) nj.call(t, i) && nq(e, i, t[i]);
          return e;
        },
        nF = (e, t, i) => nq(e, "symbol" != typeof t ? t + "" : t, i);
      class nz extends v {
        constructor(e) {
          super(e),
            nF(this, "protocol", "wc"),
            ...
            nF(this, "subscriber"),
            nF(this, "publisher"),
            nF(this, "name", "relayer"),
            nF(this, "transportExplicitlyClosed", !1),
            nF(this, "initialized", !1),
            nF(this, "connectionAttemptInProgress", !1),
            nF(this, "relayUrl"),
            nF(this, "projectId"),
            nF(this, "packageName"),
            nF(this, "bundleId"),
            nF(this, "hasExperiencedNetworkDisruption", !1),
            nF(this, "pingTimeout"),
            nF(
              this,
              "heartBeatTimeout",
            ...
            nF(this, "reconnectTimeout"),
            nF(this, "connectPromise"),
            nF(this, "reconnectInProgress", !1),
            nF(this, "requestsInFlight", []),
            nF(this, "connectTimeout", (0, k.toMiliseconds)(15 * k.ONE_SECOND)),
            nF(this, "request", async (e) => {
              var t, i;
              this.logger.debug("Publishing Request Payload");
              let r = e.id || (0, sV.getBigIntRpcId)().toString();
            ...
            nF(this, "onPayloadHandler", (e) => {
              this.onProviderPayload(e), this.resetPingTimeout();
            }),
            nF(this, "onConnectHandler", () => {
              this.logger.warn({}, "Relayer connected \uD83D\uDEDC"),
                this.startPingTimeout(),
                this.events.emit(s3.connect);
            }),
            nF(this, "onDisconnectHandler", () => {
              this.logger.warn({}, "Relayer disconnected \uD83D\uDED1"),
                (this.requestsInFlight = []),
                this.onProviderDisconnect();
            }),
            nF(this, "onProviderErrorHandler", (e) => {
              this.logger.fatal(`Fatal socket error: ${e.message}`),
                this.events.emit(s3.error, e),
                this.logger.fatal(
                  "Fatal socket error received, closing transport"
                ),
                this.transportClose();
            }),
            nF(this, "registerProviderListeners", () => {
              this.provider.on(s8.payload, this.onPayloadHandler),
                this.provider.on(s8.connect, this.onConnectHandler),
                this.provider.on(s8.disconnect, this.onDisconnectHandler),
                this.provider.on(s8.error, this.onProviderErrorHandler);
            }),
            (this.core = e.core),
            (this.logger =
            ...
            (this.messages = new nu(this.logger, e.core)),
            (this.subscriber = new nL(this, this.logger)),
            (this.publisher = new nI(this, this.logger)),
            (this.relayUrl = e?.relayUrl || s5),
        ...
        async subscribe(e, t) {
          ...
          let a =
            ...
            o,
            c = (t) => {
              t.topic === e && (this.subscriber.off(ae.created, c), o());
            };
          return (
            await Promise.all([
              new Promise((e) => {
                (o = e), this.subscriber.on(ae.created, c);
              }),
              new Promise(async (i, r) => {
                (n =
                  (await this.subscriber
                    .subscribe(
                      e,
                      nH({ internal: { throwOnFailedPublish: a } }, t)
                    )
                    .catch((e) => {
                      a && r(e);
                    })) || n),
        ...
        async onLinkMessageEvent(e, t) {
          ...
          this.events.emit(s3.message, e),
            await this.recordMessageEvent(e, s9.inbound);
        }
        async connect(e) {
          await this.confirmOnlineStateOrThrow(),
            e &&
            ...
            try {
              ...
              this.logger.debug(
                ...
                await new Promise(async (e, t) => {
                  ...
                  this.provider.once(s8.disconnect, i),
                    await te(
                      new Promise((e, t) => {
                      ...
                      .finally(() => {
                        this.provider.off(s8.disconnect, i),
        ...
        async onProviderPayload(e) {
          if (
            ...
            this.logger.debug("Emitting Relayer Payload"),
              this.logger.trace(nH({ type: "event", event: t.id }, n)),
              this.events.emit(t.id, n),
              await this.acknowledgePayload(e),
              await this.onMessageEvent(n);
          } else
            (0, sV.isJsonRpcResponse)(e) && this.events.emit(s3.message_ack, e);
        }
        ...
        async acknowledgePayload(e) {
          let t = (0, sV.formatJsonRpcResult)(e.id, !0);
          await this.provider.connection.send(t);
        }
        unregisterProviderListeners() {
          this.provider.off(s8.payload, this.onPayloadHandler),
            this.provider.off(s8.connect, this.onConnectHandler),
            this.provider.off(s8.disconnect, this.onDisconnectHandler),
            this.provider.off(s8.error, this.onProviderErrorHandler),
            clearTimeout(this.pingTimeout);
        }
        ...
        async onProviderDisconnect() {
          clearTimeout(this.pingTimeout),
            this.events.emit(s3.disconnect),
            (this.connectionAttemptInProgress = !1),
      ...
      var nZ = Object.defineProperty,
        ...
        n2 = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        n5 = (e, t) => {
          for (var i in t || (t = {})) n0.call(t, i) && n2(e, i, t[i]);
          if (nQ) for (var i of nQ(t)) n1.call(t, i) && n2(e, i, t[i]);
          return e;
        },
        n3 = (e, t, i) => n2(e, "symbol" != typeof t ? t + "" : t, i);
      class n8 extends E {
        constructor(e, t, i, r = sY, s) {
          super(e, t, i, r),
            (this.core = e),
            (this.logger = t),
            (this.name = i),
            ...
            n3(this, "getKey"),
            n3(this, "storagePrefix", sY),
            n3(this, "recentlyDeleted", []),
            n3(this, "recentlyDeletedLimit", 200),
            n3(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                await this.restore(),
                this.cached.forEach((e) => {
                  this.getKey && null !== e && !sO(e)
                  ...
                  ? this.values.filter((t) =>
                      Object.keys(e).every((i) => {
                        ...
                        return (
                                ...
                                switch (n) {
                                  ...
                                  case nY: {
                                    if (
                                      ...
                                      return !1;
                                    let n = [...Object.keys(i), ...nG(i)],
                                      o = [...Object.keys(r), ...nG(r)];
                          ...
                          })(r, e[i], void 0, void 0, void 0, void 0, nV)
                        );
                      })
                    )
                  : this.values
            ...
            n3(this, "update", async (e, t) => {
              ...
              let i = n5(n5({}, this.getData(e)), t);
              this.map.set(e, i), await this.persist();
            }),
            n3(this, "delete", async (e, t) => {
              this.isInitialized(),
                this.map.has(e) &&
      ...
      class n9 {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            n4(this, "name", "pairing"),
            n4(this, "version", "0.3"),
            n4(this, "events", new (c())()),
            n4(this, "pairings"),
            n4(this, "initialized", !1),
            n4(this, "storagePrefix", sY),
            n4(this, "ignoredPayloadTypes", [1]),
            n4(this, "registeredMethods", []),
            n4(this, "init", async () => {
              this.initialized ||
            ...
            n4(this, "register", ({ methods: e }) => {
              this.isInitialized(),
                (this.registeredMethods = [
                  ...new Set([...this.registeredMethods, ...e]),
                ]);
            }),
            n4(this, "create", async (e) => {
              this.isInitialized();
              let t = r3(),
            ...
            n4(this, "pair", async (e) => {
              let t;
              this.isInitialized();
              let i = this.core.eventClient.createEvent({
                properties: { topic: e?.uri, trace: [ac.pairing_started] },
              });
              ...
              if (
                ...
                i.addTrace(ac.pairing_uri_validation_success),
                i.addTrace(ac.pairing_uri_not_expired),
                this.pairings.keys.includes(r))
              ) {
                if (
                  ((t = this.pairings.get(r)),
                  i.addTrace(ac.existing_pairing),
                  t.active)
                )
                  throw (
                    (i.setError(al.active_pairing_already_exists),
                    Error(
                      `Pairing already exists: ${r}. Please try again with a new connection URI.`
                    ))
                  );
                i.addTrace(ac.pairing_not_expired);
              }
              let c = n || tr(k.FIVE_MINUTES),
                l = { topic: r, relay: a, expiry: c, active: !1, methods: o };
              this.core.expirer.set(r, c),
                await this.pairings.set(r, l),
                i.addTrace(ac.store_new_pairing),
                e.activatePairing && (await this.activate({ topic: r })),
                this.events.emit(ai.create, l),
                i.addTrace(ac.emit_inactive_pairing),
                this.core.crypto.keychain.has(r) ||
                  (await this.core.crypto.setSymKey(s, r)),
                i.addTrace(ac.subscribing_pairing_topic);
              try {
                await this.core.relayer.confirmOnlineStateOrThrow();
              } catch {
                i.setError(al.no_internet_connection);
              }
              try {
                await this.core.relayer.subscribe(r, { relay: a });
              } catch (e) {
                throw (i.setError(al.subscribe_pairing_topic_failure), e);
              }
              return i.addTrace(ac.subscribe_pairing_topic_success), l;
            }),
            n4(this, "activate", async ({ topic: e }) => {
              this.isInitialized();
              let t = tr(k.FIVE_MINUTES);
              this.core.expirer.set(e, t),
                await this.pairings.update(e, { active: !0, expiry: t });
            }),
            n4(this, "ping", async (e) => {
              this.isInitialized(),
              ...
              if (this.pairings.keys.includes(t)) {
                let e = await this.sendRequest(t, "wc_pairingPing", {}),
                  { done: i, resolve: r, reject: s } = e7();
                this.events.once(ta("pairing_ping", e), ({ error: e }) => {
                  e ? s(e) : r();
                }),
                  await i();
              }
            }),
            n4(this, "updateExpiry", async ({ topic: e, expiry: t }) => {
              this.isInitialized(),
                await this.pairings.update(e, { expiry: t });
            }),
            n4(this, "updateMetadata", async ({ topic: e, metadata: t }) => {
              this.isInitialized(),
            ...
            n4(this, "disconnect", async (e) => {
              ...
              this.pairings.keys.includes(t) &&
                (await this.sendRequest(
                  t,
                  "wc_pairingDelete",
                  s_("USER_DISCONNECTED")
                ),
                await this.deletePairing(t));
            }),
            n4(this, "formatUriFromPairing", (e) => {
              this.isInitialized();
            ...
            n4(this, "sendRequest", async (e, t, i) => {
              let r = (0, sV.formatJsonRpcRequest)(t, i),
            ...
            n4(this, "sendResult", async (e, t, i) => {
              let r = (0, sV.formatJsonRpcResult)(e, i),
                s = await this.core.crypto.encode(t, r),
                a = at[(await this.core.history.get(t, e)).request.method].res;
              await this.core.relayer.publish(t, s, a),
                await this.core.history.resolve(r);
            }),
            n4(this, "sendError", async (e, t, i) => {
              let r = (0, sV.formatJsonRpcError)(e, i),
                s = await this.core.crypto.encode(t, r),
                a = (await this.core.history.get(t, e)).request.method,
                n = at[a] ? at[a].res : at.unregistered_method.res;
              await this.core.relayer.publish(t, s, n),
                await this.core.history.resolve(r);
            }),
            n4(this, "deletePairing", async (e, t) => {
              await this.core.relayer.unsubscribe(e),
                await Promise.all([
                  this.pairings.delete(e, s_("USER_DISCONNECTED")),
                  this.core.crypto.deleteSymKey(e),
                  t ? Promise.resolve() : this.core.expirer.del(e),
                ]);
            }),
            n4(this, "cleanup", async () => {
              let e = this.pairings.getAll().filter((e) => ts(e.expiry));
              await Promise.all(e.map((e) => this.deletePairing(e.topic)));
            }),
            n4(this, "onRelayEventRequest", async (e) => {
            ...
            n4(this, "onRelayEventResponse", async (e) => {
              let { topic: t, payload: i } = e,
            ...
            n4(this, "onPairingPingRequest", async (e, t) => {
              let { id: i } = t;
              try {
                this.isValidPing({ topic: e }),
                  await this.sendResult(i, e, !0),
                  this.events.emit(ai.ping, { id: i, topic: e });
              } catch (t) {
                await this.sendError(i, e, t), this.logger.error(t);
              }
            }),
            n4(this, "onPairingPingResponse", (e, t) => {
              let { id: i } = t;
              setTimeout(() => {
                (0, sV.isJsonRpcResult)(t)
                  ? this.events.emit(ta("pairing_ping", i), {})
                  : (0, sV.isJsonRpcError)(t) &&
                    this.events.emit(ta("pairing_ping", i), { error: t.error });
              }, 500);
            }),
            n4(this, "onPairingDeleteRequest", async (e, t) => {
              let { id: i } = t;
              try {
                this.isValidDisconnect({ topic: e }),
                  await this.deletePairing(e),
                  this.events.emit(ai.delete, { id: i, topic: e });
              } catch (t) {
                await this.sendError(i, e, t), this.logger.error(t);
              }
            }),
            n4(this, "onUnknownRpcMethodRequest", async (e, t) => {
              let { id: i, method: r } = t;
              try {
                if (this.registeredMethods.includes(r)) return;
                let t = s_("WC_METHOD_UNSUPPORTED", r);
                await this.sendError(i, e, t), this.logger.error(t);
              } catch (t) {
                await this.sendError(i, e, t), this.logger.error(t);
              }
            }),
            n4(this, "onUnknownRpcMethodResponse", (e) => {
              this.registeredMethods.includes(e) ||
                this.logger.error(s_("WC_METHOD_UNSUPPORTED", e));
            }),
            n4(this, "isValidPair", (e, t) => {
              var i;
              if (!sL(e)) {
                let { message: i } = sA(
                  "MISSING_OR_INVALID",
                ...
                throw (t.setError(al.malformed_pairing_uri), Error(i));
              }
              if (
                !(function (e) {
                  function t(e) {
              ...
              if (!(null != (i = r?.relay) && i.protocol)) {
                ...
                throw (t.setError(al.malformed_pairing_uri), Error(e));
              }
              if (!(null != r && r.symKey)) {
                let { message: e } = sA(
                  "MISSING_OR_INVALID",
            ...
            n4(this, "isValidDisconnect", async (e) => {
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
                  `disconnect() params: ${e}`
            ...
            n4(this, "isValidPairingTopic", async (e) => {
              if (!sT(e, !1)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
              ...
              if (ts(this.pairings.get(e).expiry)) {
                await this.deletePairing(e);
        ...
        registerRelayerEvents() {
          this.core.relayer.on(s3.message, async (e) => {
        ...
        registerExpirerEvents() {
          this.core.expirer.on(as.expired, async (e) => {
            let { topic: t } = ti(e.target);
            t &&
              this.pairings.keys.includes(t) &&
              (await this.deletePairing(t, !0),
              this.events.emit(ai.expire, { topic: t }));
          });
        }
      }
      ...
      class ot extends w {
        constructor(e, t) {
          super(e, t),
            (this.core = e),
            (this.logger = t),
            oe(this, "records", new Map()),
            oe(this, "events", new o.EventEmitter()),
            oe(this, "name", "history"),
            oe(this, "version", "0.3"),
            oe(this, "cached", []),
            oe(this, "initialized", !1),
            oe(this, "storagePrefix", sY),
            oe(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                await this.restore(),
            ...
            oe(this, "set", (e, t, i) => {
              ...
              let r = {
                ...
                chainId: i,
                expiry: tr(k.THIRTY_DAYS),
              };
              this.records.set(r.id, r),
                this.persist(),
                this.events.emit(ar.created, r);
            }),
            oe(this, "resolve", async (e) => {
              if (
                (this.isInitialized(),
              ...
              typeof t.response > "u" &&
                ((t.response = (0, sV.isJsonRpcError)(e)
                  ? { error: e.error }
                  : { result: e.result }),
                this.records.set(t.id, t),
                this.persist(),
                this.events.emit(ar.updated, t));
            }),
            oe(
              this,
              "get",
        ...
        get pending() {
          ...
          return (
            this.values.forEach((t) => {
              ...
              let i = {
                topic: t.topic,
                request: (0, sV.formatJsonRpcRequest)(
                  t.request.method,
                  t.request.params,
                  t.id
                ),
          ...
          try {
            ...
            this.records.forEach((t) => {
              (0, k.toMiliseconds)(t.expiry || 0) - Date.now() <= 0 &&
                ...
                this.events.emit(ar.deleted, t, !1),
                (e = !0));
            }),
              e && this.persist();
          } catch (e) {
      ...
      class os extends I {
        constructor(e, t) {
          super(e, t),
            (this.core = e),
            (this.logger = t),
            or(this, "expirations", new Map()),
            or(this, "events", new o.EventEmitter()),
            or(this, "name", "expirer"),
            or(this, "version", "0.3"),
            or(this, "cached", []),
            or(this, "initialized", !1),
            or(this, "storagePrefix", sY),
            or(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                await this.restore(),
            ...
            or(this, "set", (e, t) => {
              ...
              this.expirations.set(i, r),
                ...
                this.events.emit(as.created, { target: i, expiration: r });
            }),
            or(this, "get", (e) => {
              this.isInitialized();
              let t = this.formatTarget(e);
            ...
            or(this, "del", (e) => {
              if ((this.isInitialized(), this.has(e))) {
                ...
                this.expirations.delete(t),
                  this.events.emit(as.deleted, { target: t, expiration: i });
              }
            }),
            or(this, "on", (e, t) => {
              this.events.on(e, t);
        ...
        formatTarget(e) {
          if ("string" == typeof e) return tt("topic", e);
          if ("number" == typeof e) return tt("id", e);
        ...
        expire(e, t) {
          this.expirations.delete(e),
            this.events.emit(as.expired, { target: e, expiration: t });
        }
        checkExpirations() {
      ...
      class oo extends N {
        constructor(e, t, i) {
          super(e, t, i),
            ...
            (this.logger = t),
            (this.store = i),
            on(this, "name", "verify-api"),
            on(this, "abortController"),
            on(this, "isDevEnv"),
            on(this, "verifyUrlV3", an),
            on(this, "storagePrefix", sY),
            on(this, "version", 2),
            on(this, "publicKey"),
            on(this, "fetchPromise"),
            on(this, "init", async () => {
              var e;
              this.isDevEnv ||
            ...
            on(this, "register", async (e) => {
              if (!e1() || this.isDevEnv) return;
            ...
            on(this, "fetchAttestation", async (e, t) => {
            ...
            on(this, "getPublicKey", async () =>
              this.publicKey
                ? this.publicKey
                : await this.fetchAndPersistPublicKey()
            ),
            on(this, "fetchAndPersistPublicKey", async () => {
            ...
            on(this, "validateAttestation", (e, t) => {
              let i = (function (e, t) {
                  let [i, r, s] = e.split("."),
                    a = ej.from(r7(s), "base64");
                  if (64 !== a.length) throw Error("Invalid signature length");
                  let n = a.slice(0, 32),
                    o = a.slice(32, 64),
                    c = iq(`${i}.${r}`),
                    l = (function (e) {
                      let t = ej.from(e.x, "base64"),
                        i = ej.from(e.y, "base64");
                      return ek([new Uint8Array([4]), t, i]);
                    })(t);
                  if (!rZ.verify(ek([n, o]), c, l))
      ...
      class oh extends A {
        constructor(e, t) {
          super(e, t),
            (this.projectId = e),
            (this.logger = t),
            ol(this, "context", "echo"),
            ol(this, "registerDeviceToken", async (e) => {
              let {
                  clientId: t,
                  token: i,
                  notificationType: r,
      ...
      var od = Object.defineProperty,
        ...
        of = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        om = (e, t) => {
          for (var i in t || (t = {})) op.call(t, i) && of(e, i, t[i]);
          if (ou) for (var i of ou(t)) og.call(t, i) && of(e, i, t[i]);
          return e;
        },
        ow = (e, t, i) => of(e, "symbol" != typeof t ? t + "" : t, i);
      class oy extends _ {
        constructor(e, t, i = !0) {
          super(e, t, i),
            (this.core = e),
            ...
            ow(this, "getEvent", (e) => {
              ...
              if (r) return om(om({}, r), this.setMethods(r.eventId));
            }),
            ...
            ow(this, "restore", async () => {
              try {
                ...
                e.forEach((e) => {
                  this.events.set(
                    e.eventId,
                    om(om({}, e), this.setMethods(e.eventId))
                  );
                });
              } catch (e) {
                this.logger.warn(e);
            ...
            ow(this, "sendEvent", async (e) => {
              ...
              return await fetch(
                `https://pulse.walletconnect.org/batch?projectId=${this.core.projectId}&st=events_sdk&sv=js-${s6}${t}`,
                { method: "POST", body: JSON.stringify(e) }
              );
            }),
            ow(this, "getAppDomain", () => e3().url),
            (this.logger = (0, d.U5)(t, this.context)),
      ...
      var ob = Object.defineProperty,
        ...
        oI = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        oN = (e, t) => {
          for (var i in t || (t = {})) oE.call(t, i) && oI(e, i, t[i]);
          if (ov) for (var i of ov(t)) oC.call(t, i) && oI(e, i, t[i]);
          return e;
        },
        oA = (e, t, i) => oI(e, "symbol" != typeof t ? t + "" : t, i);
      class o_ extends f {
        constructor(e) {
          var t;
          super(e),
            ...
            oA(this, "relayUrl"),
            oA(this, "projectId"),
            oA(this, "customStoragePrefix"),
            oA(this, "events", new o.EventEmitter()),
            oA(this, "logger"),
            oA(this, "heartbeat"),
            oA(this, "relayer"),
            oA(this, "crypto"),
            ...
            oA(this, "verify"),
            oA(this, "echoClient"),
            oA(this, "linkModeSupportedApps"),
            oA(this, "eventClient"),
            oA(this, "initialized", !1),
            oA(this, "logChunkController"),
            oA(this, "on", (e, t) => this.events.on(e, t)),
            oA(this, "once", (e, t) => this.events.once(e, t)),
            oA(this, "off", (e, t) => this.events.off(e, t)),
            oA(this, "removeListener", (e, t) =>
              this.events.removeListener(e, t)
            ),
            oA(
              this,
          ...
          (this.logChunkController = a),
            ...
            (this.crypto = new nr(this, this.logger, e?.keychain)),
            (this.history = new ot(this, this.logger)),
            (this.expirer = new os(this, this.logger)),
            (this.storage =
              null != e && e.storage
                ? e.storage
                : new h.A(oN(oN({}, sQ), e?.storageOptions))),
            (this.relayer = new nz({
              core: this,
              logger: this.logger,
              relayUrl: this.relayUrl,
            ...
            (this.pairing = new n9(this, this.logger)),
        ...
        async addLinkModeSupportedApp(e) {
          this.linkModeSupportedApps.includes(e) ||
            ...
            await this.storage.setItem(s7, this.linkModeSupportedApps));
        }
        async initialize() {
          this.logger.trace("Initialized");
          try {
        ...
        isGlobalCoreDisabled() {
          try {
            return "u" > typeof sJ && "true" === sJ.env.DISABLE_GLOBAL_CORE;
          } catch {
            return !0;
          }
        }
      ...
      let oS = "client",
        oP = `wc@2:${oS}:`,
        oO = { name: oS, logger: "error" },
        oT = "WALLETCONNECT_DEEPLINK_CHOICE",
        ok = "Proposal expired",
        ox = k.SEVEN_DAYS,
        oR = {
          wc_sessionPropose: {
        ...
        oU = { min: k.FIVE_MINUTES, max: k.SEVEN_DAYS },
        oD = { idle: "IDLE", active: "ACTIVE" },
        o$ = {
      ...
      var oB = Object.defineProperty,
        ...
        oV = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        oK = (e, t) => {
          for (var i in t || (t = {})) oF.call(t, i) && oV(e, i, t[i]);
          if (oH) for (var i of oH(t)) oz.call(t, i) && oV(e, i, t[i]);
          return e;
        },
        oG = (e, t) => oj(e, oq(t)),
        oJ = (e, t, i) => oV(e, "symbol" != typeof t ? t + "" : t, i);
      class oX extends T {
        constructor(e) {
          super(e),
            oJ(this, "name", "engine"),
            oJ(this, "events", new (c())()),
            oJ(this, "initialized", !1),
            oJ(this, "requestQueue", { state: oD.idle, queue: [] }),
            oJ(this, "sessionRequestQueue", { state: oD.idle, queue: [] }),
            oJ(this, "requestQueueDelay", k.ONE_SECOND),
            oJ(this, "expectedPairingMethodMap", new Map()),
            oJ(this, "recentlyDeletedMap", new Map()),
            oJ(this, "recentlyDeletedLimit", 200),
            oJ(this, "relayMessageCache", []),
            oJ(this, "pendingSessions", new Map()),
            oJ(this, "init", async () => {
              this.initialized ||
                (await this.cleanup(),
                this.registerRelayerEvents(),
            ...
            oJ(this, "connect", async (e) => {
              ...
              let d = await this.client.core.crypto.generateKeyPair(),
                u = oR.wc_sessionPropose.req.ttl || k.FIVE_MINUTES,
                p = tr(u),
                g = oG(
                  oK(
                    oK(
                ...
                f = ta("session_connect", g.id),
                { reject: m, resolve: w, done: y } = e7(u, ok),
                b = ({ id: e }) => {
                  e === g.id &&
                    (this.client.events.off("proposal_expire", b),
                    this.pendingSessions.delete(g.id),
                    this.events.emit(f, { error: { message: ok, code: 0 } }));
                };
              return (
            ...
            oJ(this, "approve", async (e) => {
              var t, i, r;
              let s = this.client.core.eventClient.createEvent({
                properties: {
                  topic: null == (t = e?.id) ? void 0 : t.toString(),
                  trace: [ah.session_approve_started],
                },
              });
              try {
                this.isInitialized(), await this.confirmOnlineStateOrThrow();
              } catch (e) {
                throw (s.setError(ad.no_internet_connection), e);
              }
              try {
                ...
                throw (
                  ...
                  s.setError(ad.proposal_not_found),
                  t)
                );
              }
              try {
                ...
                throw (
                  ...
                  s.setError(ad.session_approve_namespace_validation_failure),
                  e)
                );
              }
              let {
              ...
              m ||
                (m =
                  null == (r = this.client.core.eventClient)
                    ? void 0
                    : r.createEvent({
                        type: ah.session_approve_started,
                        properties: {
                          topic: u,
                          trace: [
                            ah.session_approve_started,
                            ah.session_namespaces_validation_success,
                          ],
                        },
                      }));
              let w = await this.client.core.crypto.generateKeyPair(),
                ...
                E = s4.relay;
              m.addTrace(ah.subscribing_session_topic);
              try {
                await this.client.core.relayer.subscribe(b, {
                  transportType: E,
                });
              } catch (e) {
                throw (m.setError(ad.subscribe_session_topic_failure), e);
              }
              m.addTrace(ah.subscribe_session_topic_success);
              let C = oG(oK({}, v), {
                topic: b,
                requiredNamespaces: g,
                optionalNamespaces: f,
              ...
              await this.client.session.set(b, C), m.addTrace(ah.store_session);
              try {
                m.addTrace(ah.publishing_session_settle),
                  await this.sendRequest({
                    topic: b,
                    ...
                    throw (m?.setError(ad.session_settle_publish_failure), e);
                  }),
                  m.addTrace(ah.session_settle_publish_success),
                  m.addTrace(ah.publishing_session_approve),
                  await this.sendResult({
                    ...
                    throw (m?.setError(ad.session_approve_publish_failure), e);
                  }),
                  m.addTrace(ah.session_approve_publish_success);
              } catch (e) {
                throw (
                  (this.client.logger.error(e),
                  this.client.session.delete(b, s_("USER_DISCONNECTED")),
              ...
              return (
                ...
                await this.client.proposal.delete(a, s_("USER_DISCONNECTED")),
                await this.client.core.pairing.activate({ topic: u }),
                await this.setExpiry(b, tr(ox)),
                {
                  topic: b,
                  acknowledged: () =>
            ...
            oJ(this, "reject", async (e) => {
              ...
              t &&
                ...
                await this.client.proposal.delete(i, s_("USER_DISCONNECTED")));
            }),
            oJ(this, "update", async (e) => {
              this.isInitialized(), await this.confirmOnlineStateOrThrow();
              try {
              ...
              let { topic: t, namespaces: i } = e,
                { done: r, resolve: s, reject: a } = e7(),
                n = (0, sV.payloadId)(),
                o = (0, sV.getBigIntRpcId)().toString(),
                c = this.client.session.get(t).namespaces;
              return (
                this.events.once(ta("session_update", n), ({ error: e }) => {
                  e ? a(e) : s();
                }),
            ...
            oJ(this, "extend", async (e) => {
              ...
              let { topic: t } = e,
                ...
                { done: r, resolve: s, reject: a } = e7();
              return (
                this.events.once(ta("session_extend", i), ({ error: e }) => {
                  e ? a(e) : s();
                }),
                await this.setExpiry(t, tr(ox)),
                this.sendRequest({
                  topic: t,
            ...
            oJ(this, "request", async (e) => {
              ...
              let {
                  ...
                  request: i,
                  topic: r,
                  expiry: s = oR.wc_sessionRequest.req.ttl,
                } = e,
                a = this.client.session.get(r);
              a?.transportType === s4.relay &&
                (await this.confirmOnlineStateOrThrow());
              let n = (0, sV.payloadId)(),
                o = (0, sV.getBigIntRpcId)().toString(),
                {
                  done: c,
                  resolve: l,
                  reject: h,
                } = e7(s, "Request expired. Please try again.");
              this.events.once(
                ta("session_request", n),
                ({ error: e, result: t }) => {
                  e ? h(e) : l(t);
                }
              );
              ...
              if (u)
                return (
                  await this.sendRequest({
                    ...
                    method: d,
                    params: {
                      request: oG(oK({}, i), { expiryTimestamp: tr(s) }),
                      chainId: t,
                    },
                    expiry: s,
                    throwOnFailedPublish: !0,
              ...
              return await Promise.all([
                ...
                new Promise(async (e) => {
                  ...
                  if (!(null != (t = a.sessionConfig) && t.disableDeepLink)) {
                    let e = await tc(this.client.core.storage, oT);
            ...
            oJ(this, "ping", async (e) => {
              ...
              if (this.client.session.keys.includes(t)) {
                let e = (0, sV.payloadId)(),
                  i = (0, sV.getBigIntRpcId)().toString(),
                  { done: r, resolve: s, reject: a } = e7();
                this.events.once(ta("session_ping", e), ({ error: e }) => {
                  e ? a(e) : s();
                }),
                  await Promise.all([
                    this.sendRequest({
            ...
            oJ(this, "getPendingSessionRequests", () =>
              this.client.pendingRequest.getAll()
            ),
            oJ(this, "authenticate", async (e, t) => {
              var i, r, s;
              let a;
              ...
              let n =
                  ...
                  (null == (i = this.client.metadata.redirect)
                    ? void 0
                    : i.linkMode),
                o = n ? s4.link_mode : s4.relay;
              o === s4.relay && (await this.confirmOnlineStateOrThrow());
              let {
                  chains: c,
                  statement: l = "",
                  uri: h,
              ...
              if (
                (await Promise.all([
                  this.client.auth.authKeys.set(oW, {
                    responseTopic: C,
                    publicKey: E,
                  }),
                          ...
                          Object.keys(
                            ...
                            .forEach((s) => {
                              ...
                              r.att[i] = tJ(
                                ((e, t) => {
                                  for (var i in t || (t = {}))
                                    tZ.call(t, i) && t0(e, i, t[i]);
                                  if (tY)
                                    for (var i of tY(t))
                                      tQ.call(t, i) && t0(e, i, t[i]);
                                  return e;
                                })({}, r.att[i]),
                                tX({
                                  [s]:
              ...
              let I =
                  w && w > oR.wc_sessionAuthenticate.req.ttl
                    ? w
                ...
                A = {
                  ...
                  expiryTimestamp: tr(oR.wc_sessionPropose.req.ttl),
                  id: (0, sV.payloadId)(),
                },
                { done: _, resolve: S, reject: P } = e7(I, "Request expired"),
                O = (0, sV.payloadId)(),
                T = ta("session_connect", A.id),
                k = ta("session_request", O),
                ...
                R = async (e) => {
                  ...
                  l.length > 0 &&
                    ((a = {
                      ...
                      relay: { protocol: "irn" },
                      pairingTopic: b,
                      namespaces: sC([...new Set(l)], [...new Set(h)]),
                      transportType: o,
                    }),
              ...
              try {
                if (n) {
                  let e = (0, sV.formatJsonRpcRequest)(
                    "wc_sessionAuthenticate",
                    N,
                    O
                  );
            ...
            oJ(this, "approveSessionAuthenticate", async (e) => {
              let t,
                { id: i, auths: r } = e,
                s = this.client.core.eventClient.createEvent({
                  properties: {
                    topic: i.toString(),
                    trace: [au.authenticated_session_approve_started],
                  },
                });
              try {
                this.isInitialized();
              } catch (e) {
                throw (s.setError(ap.no_internet_connection), e);
              }
              let a = this.getPendingAuthRequest(i);
              if (!a)
                throw (
                  (s.setError(
                    ap.authenticated_session_pending_request_not_found
                  ),
                  Error(`Could not find pending auth request with id ${i}`))
                );
              let n = a.transportType || s4.relay;
              n === s4.relay && (await this.confirmOnlineStateOrThrow());
              ...
              if (
                (s.addTrace(au.create_authenticated_session_topic),
                d?.length > 0)
              ) {
                (t = {
                  topic: p,
                  ...
                  namespaces: sC([...new Set(d)], [...new Set(u)]),
                  transportType: n,
                }),
                ...
                try {
                  ...
                  throw (
                    (s.setError(
                      ap.subscribe_authenticated_session_topic_failure
                    ),
                    e)
                  );
                }
                s.addTrace(au.subscribe_authenticated_session_topic_success),
                  await this.client.session.set(p, t),
                  s.addTrace(au.store_authenticated_session),
                  await this.client.core.pairing.updateMetadata({
                    topic: a.pairingTopic,
                    metadata: a.requester.metadata,
                  });
              }
              s.addTrace(au.publishing_authenticated_session_approve);
              try {
                await this.sendResult({
                  topic: l,
                  id: i,
                ...
                throw (
                  (s.setError(ap.authenticated_session_approve_publish_failure),
                  e)
                );
              }
              return (
            ...
            oJ(this, "rejectSessionAuthenticate", async (e) => {
              ...
              await this.sendError({
                ...
                await this.client.proposal.delete(t, s_("USER_DISCONNECTED"));
            }),
            oJ(this, "formatAuthMessage", (e) => {
              this.isInitialized();
              let { request: t, iss: i } = e;
              return t8(t, i);
            }),
            oJ(this, "processRelayMessageCache", () => {
              setTimeout(async () => {
            ...
            oJ(this, "cleanupDuplicatePairings", async (e) => {
              if (e.pairingTopic)
                try {
            ...
            oJ(this, "deleteSession", async (e) => {
              ...
              await this.client.core.relayer.unsubscribe(i),
                await this.client.session.delete(i, s_("USER_DISCONNECTED")),
                ...
                i ===
                  (null == (t = this.sessionRequestQueue.queue[0])
                    ? void 0
                    : t.topic) && (this.sessionRequestQueue.state = oD.idle),
                s &&
            ...
            oJ(this, "deleteProposal", async (e, t) => {
              if (t)
                try {
                  ...
                  i?.setError(ad.proposal_expired);
                } catch {}
              await Promise.all([
                this.client.proposal.delete(e, s_("USER_DISCONNECTED")),
                t ? Promise.resolve() : this.client.core.expirer.del(e),
              ]),
                this.addToRecentlyDeleted(e, "proposal");
            }),
            oJ(this, "deletePendingSessionRequest", async (e, t, i = !1) => {
              await Promise.all([
                ...
                i &&
                  ((this.sessionRequestQueue.state = oD.idle),
                  this.client.events.emit("session_request_expire", { id: e }));
            }),
            oJ(this, "deletePendingAuthRequest", async (e, t, i = !1) => {
              await Promise.all([
                this.client.auth.requests.delete(e, t),
                i ? Promise.resolve() : this.client.core.expirer.del(e),
              ]);
            }),
            oJ(this, "setExpiry", async (e, t) => {
              this.client.session.keys.includes(e) &&
                (this.client.core.expirer.set(e, t),
                await this.client.session.update(e, { expiry: t }));
            }),
            oJ(this, "setProposal", async (e, t) => {
              this.client.core.expirer.set(e, tr(oR.wc_sessionPropose.req.ttl)),
                await this.client.proposal.set(e, t);
            }),
            oJ(this, "setAuthRequest", async (e, t) => {
              let {
                request: i,
                pairingTopic: r,
                transportType: s = s4.relay,
              } = t;
            ...
            oJ(this, "setPendingSessionRequest", async (e) => {
              let { id: t, topic: i, params: r, verifyContext: s } = e,
                a =
                  r.request.expiryTimestamp || tr(oR.wc_sessionRequest.req.ttl);
            ...
            oJ(this, "sendRequest", async (e) => {
              let t,
                ...
                p = (0, sV.formatJsonRpcRequest)(a, n, l),
                g = !!d;
              try {
                let e = g ? r2 : r1;
              ...
              if (
                ...
                o && (e.ttl = o),
                  c && (e.id = c),
                  (e.tvf = oG(oK({}, u), { correlationId: p.id })),
                  h
                    ? ((e.internal = oG(oK({}, e.internal), {
                        throwOnFailedPublish: !0,
                      })),
            ...
            oJ(this, "sendResult", async (e) => {
              let t,
                ...
                d = (0, sV.formatJsonRpcResult)(a, o),
              ...
              if (u) {
                ...
                let e = oR[r.request.method].res;
                (e.tvf = oG(oK({}, s), { correlationId: a })),
                  c
                    ? ((e.internal = oG(oK({}, e.internal), {
                        throwOnFailedPublish: !0,
                      })),
            ...
            oJ(this, "cleanup", async () => {
              ...
              this.client.session.getAll().forEach((t) => {
                ...
                this.client.proposal.getAll().forEach((e) => {
                  ts(e.expiryTimestamp) && t.push(e.id);
                }),
                await Promise.all([
            ...
            oJ(this, "onProviderMessageEvent", async (e) => {
              !this.initialized || this.relayMessageCache.length > 0
                ? this.relayMessageCache.push(e)
                : await this.onRelayMessage(e);
            }),
            oJ(this, "onRelayEventRequest", async (e) => {
              this.requestQueue.queue.push(e),
                await this.processRequestsQueue();
            }),
            oJ(this, "processRequestsQueue", async () => {
              if (this.requestQueue.state === oD.active)
              ...
              for (
                ...
                this.requestQueue.state = oD.active;
              ...
              this.requestQueue.state = oD.idle;
            }),
            oJ(this, "processRequest", async (e) => {
              let {
                  topic: t,
                  payload: i,
                  attestation: r,
            ...
            oJ(this, "onRelayEventResponse", async (e) => {
            ...
            oJ(this, "onRelayEventUnknownPayload", (e) => {
              let { topic: t } = e,
                { message: i } = sA(
                  "MISSING_OR_INVALID",
            ...
            oJ(this, "shouldIgnorePairingRequest", (e) => {
            ...
            oJ(this, "onSessionProposeRequest", async (e) => {
              ...
              try {
                ...
                0 === this.client.events.listenerCount("session_proposal") &&
                  ...
                  e?.setError(al.proposal_listener_not_found)),
                  this.isValidConnect(oK({}, i.params));
                let o = a.expiryTimestamp || tr(oR.wc_sessionPropose.req.ttl),
                  c = oK({ id: n, pairingTopic: t, expiryTimestamp: o }, a);
                await this.setProposal(n, c);
                let l = await this.getVerifyContext({
                  attestationId: r,
                  hash: r6(JSON.stringify(i)),
                  encryptedId: s,
                  metadata: c.proposer.metadata,
                });
                e?.addTrace(ac.emit_session_proposal),
            ...
            oJ(this, "onSessionProposeResponse", async (e, t, i) => {
              let { id: r } = t;
              if ((0, sV.isJsonRpcResult)(t)) {
                let { result: s } = t;
              ...
              } else if ((0, sV.isJsonRpcError)(t)) {
                await this.client.proposal.delete(r, s_("USER_DISCONNECTED"));
                let e = ta("session_connect", r);
                if (0 === this.events.listenerCount(e))
                  throw Error(`emitting ${e} without any listeners, 954`);
                this.events.emit(e, { error: t.error });
              }
            }),
            oJ(this, "onSessionSettleRequest", async (e, t) => {
              let { id: i, params: r } = t;
              try {
                ...
                await this.client.session.set(u.topic, u),
                  ...
                  this.events.emit(ta("session_connect", h.proposalId), {
                    session: u,
                  }),
            ...
            oJ(this, "onSessionSettleResponse", async (e, t) => {
              let { id: i } = t;
              (0, sV.isJsonRpcResult)(t)
                ? (await this.client.session.update(e, { acknowledged: !0 }),
                  this.events.emit(ta("session_approve", i), {}))
                : (0, sV.isJsonRpcError)(t) &&
                  (await this.client.session.delete(e, s_("USER_DISCONNECTED")),
                  this.events.emit(ta("session_approve", i), {
                    error: t.error,
                  }));
            }),
            oJ(this, "onSessionUpdateRequest", async (e, t) => {
              let { params: i, id: r } = t;
              try {
                ...
                if (s && this.isRequestOutOfSync(s, r)) {
                  this.client.logger.warn(
                    ...
                    this.sendError({
                      id: r,
                      topic: e,
                      error: s_("INVALID_UPDATE_REQUEST"),
                    });
                  return;
                }
                this.isValidUpdate(oK({ topic: e }, i));
                try {
                  sF.set(t, r),
            ...
            oJ(this, "onSessionUpdateResponse", (e, t) => {
              let { id: i } = t,
                r = ta("session_update", i);
              if (0 === this.events.listenerCount(r))
                throw Error(`emitting ${r} without any listeners`);
              (0, sV.isJsonRpcResult)(t)
                ? this.events.emit(ta("session_update", i), {})
                : (0, sV.isJsonRpcError)(t) &&
                  this.events.emit(ta("session_update", i), { error: t.error });
            }),
            oJ(this, "onSessionExtendRequest", async (e, t) => {
              let { id: i } = t;
              try {
                this.isValidExtend({ topic: e }),
                  await this.setExpiry(e, tr(ox)),
                  await this.sendResult({
                    id: i,
                    topic: e,
                    result: !0,
            ...
            oJ(this, "onSessionExtendResponse", (e, t) => {
              let { id: i } = t,
                r = ta("session_extend", i);
              if (0 === this.events.listenerCount(r))
                throw Error(`emitting ${r} without any listeners`);
              (0, sV.isJsonRpcResult)(t)
                ? this.events.emit(ta("session_extend", i), {})
                : (0, sV.isJsonRpcError)(t) &&
                  this.events.emit(ta("session_extend", i), { error: t.error });
            }),
            oJ(this, "onSessionPingRequest", async (e, t) => {
              let { id: i } = t;
              try {
                this.isValidPing({ topic: e }),
                  await this.sendResult({
            ...
            oJ(this, "onSessionPingResponse", (e, t) => {
              let { id: i } = t,
                r = ta("session_ping", i);
              setTimeout(() => {
                if (0 === this.events.listenerCount(r))
                ...
                (0, sV.isJsonRpcResult)(t)
                  ? this.events.emit(ta("session_ping", i), {})
                  : (0, sV.isJsonRpcError)(t) &&
                    this.events.emit(ta("session_ping", i), { error: t.error });
              }, 500);
            }),
            oJ(this, "onSessionDeleteRequest", async (e, t) => {
              let { id: i } = t;
              try {
                this.isValidDisconnect({ topic: e, reason: t.params }),
                  Promise.all([
                    new Promise((t) => {
                      this.client.core.relayer.once(s3.publish, async () => {
            ...
            oJ(this, "onSessionRequest", async (e) => {
              var t, i, r;
              let {
                  topic: s,
                  payload: a,
                ...
                { id: l, params: h } = a;
              try {
                await this.isValidRequest(oK({ topic: s }, h));
                let e = this.client.session.get(s),
                  a = await this.getVerifyContext({
                    attestationId: n,
                    hash: r6(
                      JSON.stringify(
                        (0, sV.formatJsonRpcRequest)("wc_sessionRequest", h, l)
                      )
                    ),
                    encryptedId: o,
            ...
            oJ(this, "onSessionRequestResponse", (e, t) => {
              let { id: i } = t,
                r = ta("session_request", i);
              if (0 === this.events.listenerCount(r))
                throw Error(`emitting ${r} without any listeners`);
              (0, sV.isJsonRpcResult)(t)
                ? this.events.emit(ta("session_request", i), {
                    result: t.result,
                  })
                : (0, sV.isJsonRpcError)(t) &&
                  this.events.emit(ta("session_request", i), {
            ...
            oJ(this, "onSessionEventRequest", async (e, t) => {
              let { id: i, params: r } = t;
              try {
            ...
            oJ(this, "onSessionAuthenticateResponse", (e, t) => {
              let { id: i } = t;
              this.client.logger.trace({
                type: "method",
            ...
            oJ(this, "onSessionAuthenticateRequest", async (e) => {
              var t;
              let {
                topic: i,
                payload: r,
            ...
            oJ(this, "addSessionRequestToSessionRequestQueue", (e) => {
              this.sessionRequestQueue.queue.push(e);
            }),
            oJ(this, "cleanupAfterResponse", (e) => {
              ...
              ({ topic: e, error: t }) => {
                ...
                i.length > 0 &&
                  i
                    ...
                    .forEach((e) => {
                      let i = ta("session_request", e.request.id);
                      if (0 === this.events.listenerCount(i))
                        throw Error(`emitting ${i} without any listeners`);
                      this.events.emit(ta("session_request", e.request.id), {
                        error: t,
                      });
                    });
              }
            ),
            oJ(this, "processSessionRequestQueue", () => {
              if (this.sessionRequestQueue.state === oD.active)
                return void this.client.logger.info(
              ...
              try {
                (this.sessionRequestQueue.state = oD.active),
                  this.emitSessionRequest(e);
              } catch (e) {
                this.client.logger.error(e);
              }
            }),
            oJ(this, "emitSessionRequest", (e) => {
              this.client.events.emit("session_request", e);
            }),
            oJ(this, "onPairingCreated", (e) => {
              if (
                (e.methods &&
              ...
              t &&
                this.onSessionProposeRequest({
                  topic: e.topic,
                  payload: (0, sV.formatJsonRpcRequest)(
                    "wc_sessionPropose",
                    oG(oK({}, t), {
            ...
            oJ(this, "isValidConnect", async (e) => {
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
              ...
              if (
                (sO(t) || (await this.isValidPairingTopic(t)),
                !(function (e, t) {
                  let i = !1;
                  return (
                    t && !e
              ...
              if (
                ...
                sO(s) || this.validateSessionProps(s, "sessionProperties"),
                !sO(a))
              ) {
            ...
            oJ(this, "validateNamespaces", (e, t) => {
            ...
            oJ(this, "isValidApprove", async (e) => {
              if (!sL(e))
                throw Error(
              ...
              let c = sW(n.requiredNamespaces, i, "approve()");
            ...
            oJ(this, "isValidSessionSettleRequest", (e) => {
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
              ...
              let n = sD(r, "onSessionSettleRequest()");
            ...
            oJ(this, "isValidUpdate", async (e) => {
              ...
              let a = sW(r.requiredNamespaces, i, "update()");
              if (a) throw Error(a.message);
            }),
            oJ(this, "isValidExtend", async (e) => {
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
                  `extend() params: ${e}`
            ...
            oJ(this, "isValidRequest", async (e) => {
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
                  `request() params: ${e}`
                ...
                !(function (e, t, i) {
                  return (
                    ...
                    (function (e, t) {
                      ...
                      return (
                        Object.values(e).forEach((e) => {
                          sy(e.accounts).includes(t) && i.push(...e.methods);
                        }),
                        i
                      );
                    })(e, t).includes(i)
              ...
              if (
                s &&
                !(function (e, t) {
                  return sk(e, !1) && e <= t.max && e >= t.min;
                })(s, oU)
              ) {
                let { message: e } = sA(
                  "MISSING_OR_INVALID",
                  `request() expiry: ${s}. Expiry must be a number (in seconds) between ${oU.min} and ${oU.max}`
                );
                throw Error(e);
              }
            }),
            oJ(this, "isValidRespond", async (e) => {
              var t;
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
                ...
                !(function (e, t, i) {
                  return (
                    ...
                    (function (e, t) {
                      ...
                      return (
                        Object.values(e).forEach((e) => {
                          sy(e.accounts).includes(t) && i.push(...e.events);
                        }),
                        i
                      );
                    })(e, t).includes(i)
            ...
            oJ(this, "isValidDisconnect", async (e) => {
              if (!sL(e)) {
                let { message: t } = sA(
                  "MISSING_OR_INVALID",
                  `disconnect() params: ${e}`
            ...
            oJ(this, "isValidAuthenticate", (e) => {
              let { chains: t, uri: i, domain: r, nonce: s } = e;
              if (!Array.isArray(t) || 0 === t.length)
                throw Error("chains is required and must be a non-empty array");
              if (!sT(i, !1)) throw Error("uri is required parameter");
              if (!sT(r, !1)) throw Error("domain is required parameter");
              if (!sT(s, !1)) throw Error("nonce is required parameter");
              if ([...new Set(t.map((e) => eq(e).namespace))].length > 1)
                throw Error(
                  "Multi-namespace requests are not supported. Please request single namespace only."
                );
              let { namespace: a } = eq(t[0]);
              if ("eip155" !== a)
                throw Error(
                  "Only eip155 namespace is supported for authenticated sessions. Please use .connect() for non-eip155 chains."
                );
            }),
            oJ(this, "getVerifyContext", async (e) => {
              let {
                  attestationId: t,
                  hash: i,
                  encryptedId: r,
            ...
            oJ(this, "validateSessionProps", (e, t) => {
            ...
            oJ(this, "checkRecentlyDeleted", (e) => {
            ...
            oJ(this, "getAppLinkIfEnabled", (e, t) => {
              var i;
            ...
            oJ(this, "handleLinkModeMessage", ({ url: e }) => {
              if (!e || !e.includes("wc_ev") || !e.includes("topic")) return;
              let t = tl(e, "topic") || "",
                i = decodeURIComponent(tl(e, "wc_ev") || ""),
                r = this.client.session.keys.includes(t);
              r &&
                this.client.session.update(t, { transportType: s4.link_mode }),
            ...
            oJ(this, "registerLinkModeListeners", async () => {
              var e;
              if (
                td() ||
                (e0() &&
            ...
            oJ(this, "shouldSetTVF", (e, t) => {
              if (!t || "wc_sessionRequest" !== e) return !1;
              let { request: i } = t;
              return Object.keys(o$).includes(i.method);
            }),
            oJ(this, "getTVFParams", (e, t, i) => {
              var r, s;
              try {
            ...
            oJ(this, "extractTxHashesFromResult", (e, t) => {
              try {
                let i = o$[e];
                  ...
                  return "solana_signAllTransactions" === e
                    ? r.map((e) =>
                        (function (e) {
                          ...
                          let s = ej.from(e, "base64").slice(1, 65);
        ...
        registerRelayerEvents() {
          this.client.core.relayer.on(s3.message, (e) => {
            this.onProviderMessageEvent(e);
          });
        }
        async onRelayMessage(e) {
          let { topic: t, message: i, attestation: r, transportType: s } = e,
            { publicKey: a } = this.client.auth.authKeys.keys.includes(oW)
              ? this.client.auth.authKeys.get(oW)
              : { responseTopic: void 0, publicKey: void 0 };
          try {
            let e = await this.client.core.crypto.decode(t, i, {
              receiverPublicKey: a,
              encoding: s === s4.link_mode ? r2 : r1,
            });
            (0, sV.isJsonRpcRequest)(e)
        ...
        registerPairingEvents() {
          this.client.core.pairing.events.on(ai.create, (e) =>
            this.onPairingCreated(e)
          ),
            this.client.core.pairing.events.on(ai.delete, (e) => {
        ...
        isValidPairingTopic(e) {
          ...
          if (ts(this.client.core.pairing.pairings.get(e).expiry)) {
            let { message: t } = sA("EXPIRED", `pairing topic: ${e}`);
            throw Error(t);
          }
        }
        async isValidSessionTopic(e) {
          ...
          if (ts(this.client.session.get(e).expiry)) {
        ...
        async isValidProposalId(e) {
          ...
          if (ts(this.client.proposal.get(e).expiryTimestamp)) {
      ...
      class oY extends n8 {
        constructor(e, t) {
          super(e, t, "proposal", oP), (this.core = e), (this.logger = t);
        }
      }
      class oZ extends n8 {
        constructor(e, t) {
          super(e, t, "session", oP), (this.core = e), (this.logger = t);
        }
      }
      class oQ extends n8 {
        constructor(e, t) {
          super(e, t, "request", oP, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
      ...
      class o1 extends n8 {
        constructor(e, t) {
          super(e, t, "pairingTopics", oM), (this.core = e), (this.logger = t);
        }
      }
      class o2 extends n8 {
        constructor(e, t) {
          super(e, t, "requests", oM, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
      ...
      class o8 {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            o3(this, "authKeys"),
            o3(this, "pairingTopics"),
            o3(this, "requests"),
            (this.authKeys = new o0(this.core, this.logger)),
            (this.pairingTopics = new o1(this.core, this.logger)),
            (this.requests = new o2(this.core, this.logger));
        }
        async init() {
      ...
      class o9 extends O {
        constructor(e) {
          super(e),
            o4(this, "protocol", "wc"),
            o4(this, "version", 2),
            o4(this, "name", oO.name),
            o4(this, "metadata"),
            o4(this, "core"),
            o4(this, "logger"),
            o4(this, "events", new o.EventEmitter()),
            o4(this, "engine"),
            o4(this, "session"),
            o4(this, "proposal"),
            o4(this, "pendingRequest"),
            o4(this, "auth"),
            o4(this, "signConfig"),
            o4(this, "on", (e, t) => this.events.on(e, t)),
            o4(this, "once", (e, t) => this.events.once(e, t)),
            o4(this, "off", (e, t) => this.events.off(e, t)),
            o4(this, "removeListener", (e, t) =>
              this.events.removeListener(e, t)
            ),
            o4(this, "removeAllListeners", (e) =>
              this.events.removeAllListeners(e)
            ),
            o4(this, "connect", async (e) => {
              try {
            ...
            o4(this, "getPendingSessionRequests", () => {
              try {
            ...
            o4(this, "authenticate", async (e, t) => {
              try {
            ...
            o4(this, "approveSessionAuthenticate", async (e) => {
              try {
            ...
            o4(this, "rejectSessionAuthenticate", async (e) => {
              try {
          ...
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ? e.logger
              : (0, d.h6)((0, d.iP)({ level: e?.logger || oO.logger }));
          (this.core = e?.core || new o_(e)),
            (this.logger = (0, d.U5)(t, this.name)),
            (this.session = new oZ(this.core, this.logger)),
            (this.proposal = new oY(this.core, this.logger)),
            (this.pendingRequest = new oQ(this.core, this.logger)),
            (this.engine = new oX(this)),
            (this.auth = new o8(this.core, this.logger));
        }
        static async init(e) {
          let t = new o9(e);
      ...
      let cp = "[object String]",
        cg = "[object Number]",
        cf = "[object Boolean]",
        cm = "[object Arguments]";
      function cw(e, t, i, r = new Map(), s) {
        let a = s?.(e, t, i, r);
        if (null != a) return a;
        if (cc(e)) return e;
        ...
        if (Array.isArray(e)) {
          ...
          r.set(e, t);
          for (let a = 0; a < e.length; a++) t[a] = cw(e[a], a, i, r, s);
          return (
        ...
        if (e instanceof Map) {
          let t = new Map();
          for (let [a, n] of (r.set(e, t), e)) t.set(a, cw(n, a, i, r, s));
          return t;
        }
        if (e instanceof Set) {
          let t = new Set();
          for (let a of (r.set(e, t), e)) t.add(cw(a, void 0, i, r, s));
          return t;
        }
        if ("u" > typeof ce && ce.isBuffer(e)) return e.subarray();
        if (cl(e)) {
        ...
        if (e instanceof DataView) {
          ...
          return r.set(e, t), cy(t, e, i, r, s), t;
        }
      ...
      function cy(e, t, i = e, r, s) {
        let a = [...Object.keys(t), ...cd(t)];
        for (let n = 0; n < a.length; n++) {
          let o = a[n],
            c = Object.getOwnPropertyDescriptor(e, o);
          (null == c || c.writable) && (e[o] = cw(t[o], o, i, r, s));
        }
      }
      function cb(e) {
        var t;
        return (
          ...
          cw(e, void 0, e, new Map(), t)
        );
      }
      function cv(e) {
        return (
          null !== e && "object" == typeof e && "[object Arguments]" === cu(e)
        );
      }
      var cE = Object.defineProperty,
        ...
        cS = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        cP = (e, t) => {
          for (var i in t || (t = {})) cA.call(t, i) && cS(e, i, t[i]);
          if (cN) for (var i of cN(t)) c_.call(t, i) && cS(e, i, t[i]);
          return e;
        },
        cO = (e, t) => cC(e, cI(t));
      function cT(e, t, i) {
          ...
          return (function (e, ...t) {
            ...
            for (let e = 0; e < i.length; e++)
              s = (function e(t, i, r, s) {
                if (
                  (cc(t) && (t = Object(t)), null == i || "object" != typeof i)
                )
                  return t;
                if (s.has(i))
                  return (function (e) {
                ...
                for (let n = 0; n < a.length; n++) {
                  ...
                  if (
                    (cv(c) && (c = { ...c }),
                    cv(l) && (l = { ...l }),
                    "u" > typeof ce && ce.isBuffer(c) && (c = cb(c)),
                    Array.isArray(c))
                  )
      ...
      function cU(e) {
        ...
        for (let [o, c] of Object.entries(e)) {
          let e = sb(o) ? [o] : c.chains,
            l = c.methods || [],
            h = c.events || [],
            d = c.rpcMap || {},
            u = sv(o);
          (n[u] = cO(cP(cP({}, n[u]), c), {
            chains: tn(e, null == (t = n[u]) ? void 0 : t.chains),
            methods: tn(l, null == (i = n[u]) ? void 0 : i.methods),
            events: tn(h, null == (r = n[u]) ? void 0 : r.events),
          })),
            (sP(d) || sP((null == (s = n[u]) ? void 0 : s.rpcMap) || {})) &&
              (n[u].rpcMap = cP(
                cP({}, d),
      ...
      function c$(e) {
        ...
        for (let [i, r] of Object.entries(e)) {
          let e = r.methods || [],
            s = r.events || [],
            a = r.accounts || [],
            n = sb(i) ? [i] : r.chains ? r.chains : cx(r.accounts);
      ...
      class cH {
        constructor(e) {
          cq(this, "name", "polkadot"),
            ...
            (this.events = cW("events")),
            (this.client = cW("client")),
        ...
        createHttpProvider(e, t) {
          let i = t || cT(e, this.namespace, this.client.core.projectId);
          if (!i) throw Error(`No RPC url provided for chainId: ${e}`);
          return new sz.F(new o7.A(i, cW("disableProviderPing")));
        }
      }
      var cF = Object.defineProperty,
        ...
        cX = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        cY = (e, t) => {
          for (var i in t || (t = {})) cG.call(t, i) && cX(e, i, t[i]);
          if (cK) for (var i of cK(t)) cJ.call(t, i) && cX(e, i, t[i]);
          return e;
        },
        cZ = (e, t) => cz(e, cV(t)),
        cQ = (e, t, i) => cX(e, "symbol" != typeof t ? t + "" : t, i);
      class c0 {
        constructor(e) {
          cQ(this, "name", "eip155"),
            cQ(this, "client"),
        ...
        createHttpProvider(e, t) {
          let i =
            t ||
            cT(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
          if (!i) throw Error(`No RPC url provided for chainId: ${e}`);
          return new sz.F(new o7.V(i, cW("disableProviderPing")));
        }
        setHttpProvider(e, t) {
          let i = this.createHttpProvider(e, t);
          i && (this.httpProviders[e] = i);
        ...
        async getCapabilities(e) {
          ...
          try {
            await this.client.session.update(e.topic, {
              sessionProperties: cZ(cY({}, l.sessionProperties || {}), {
                capabilities: cZ(cY({}, h || {}), { [c]: d }),
              }),
            });
          } catch (e) {
        ...
        async getUserOperationReceipt(e, t) {
          ...
          let r = new URL(e),
            s = await fetch(r, {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify(
                (0, sV.formatJsonRpcRequest)("eth_getUserOperationReceipt", [
        ...
        getBundlerUrl(e, t) {
          return `${ca}?projectId=${this.client.core.projectId}&chainId=${e}&bundler=${t}`;
        }
      }
      ...
      class c7 {
        constructor(e) {
          c9(this, "name", "algorand"),
            c9(this, "client"),
            c9(this, "httpProviders"),
            c9(this, "events"),
            c9(this, "namespace"),
            c9(this, "chainId"),
            (this.namespace = e.namespace),
        ...
        createHttpProvider(e, t) {
          ...
          return typeof i > "u"
            ? void 0
            : new sz.F(new o7.A(i, cW("disableProviderPing")));
        }
      }
      ...
      class ld {
        ...
        setDefaultChain(e, t) {
          if (((this.chainId = e), !this.httpProviders[e])) {
            let i = t || cT(`${this.name}:${e}`, this.namespace);
            if (!i) throw Error(`No RPC url provided for chainId: ${e}`);
            this.setHttpProvider(e, i);
          }
          this.events.emit(
      ...
      class lg {
        ...
        createHttpProvider(e, t) {
          let i = t || cT(e, this.namespace);
          return typeof i > "u" ? void 0 : new sz.F(new o7.A(i));
        }
      }
      ...
      var ly = Object.defineProperty,
        ...
        lN = (e, t, i) =>
          t in e
            ...
            : (e[t] = i),
        lA = (e, t) => {
          for (var i in t || (t = {})) lC.call(t, i) && lN(e, i, t[i]);
          if (lE) for (var i of lE(t)) lI.call(t, i) && lN(e, i, t[i]);
          return e;
        },
        l_ = (e, t) => lb(e, lv(t)),
        lS = (e, t, i) => lN(e, "symbol" != typeof t ? t + "" : t, i);
      class lP {
        constructor(e) {
          lS(this, "client"),
            lS(this, "namespaces"),
            lS(this, "optionalNamespaces"),
            lS(this, "sessionProperties"),
            lS(this, "scopedProperties"),
            lS(this, "events", new (c())()),
            lS(this, "rpcProviders", {}),
            lS(this, "session"),
            lS(this, "providerOpts"),
            lS(this, "logger"),
            lS(this, "uri"),
            lS(this, "disableProviderPing", !1),
            (this.providerOpts = e),
            (this.logger =
              "u" > typeof e?.logger && "string" != typeof e?.logger
                ? e.logger
                : (0, d.h6)((0, d.iP)({ level: e?.logger || ct }))),
        ...
        sendAsync(e, t, i, r) {
          ...
          this.request(e, i, r)
            .then((e) => t(null, (0, sV.formatJsonRpcResult)(s, e)))
            .catch((e) => t(e, void 0));
        }
        async enable() {
        ...
        async authenticate(e, t) {
          ...
          if (((this.session = s.session), this.session)) {
            let e = c$(this.session.namespaces);
            (this.namespaces = cR(this.namespaces, e)),
        ...
        async pair(e) {
          ...
          let r = await i();
          this.session = r;
          let s = c$(r.namespaces);
          return (
            (this.namespaces = cR(this.namespaces, s)),
            await this.persist("namespaces", this.namespaces),
          ...
          if (
            ((this.client =
              ...
              (await o9.init({
                ...
                logger: this.providerOpts.logger || ct,
                relayUrl:
        ...
        createProviders() {
          ...
          let e = [
            ...new Set(Object.keys(this.session.namespaces).map((e) => sv(e))),
          ];
          cB("client", this.client),
            cB("events", this.events),
            cB("disableProviderPing", this.disableProviderPing),
            e.forEach((e) => {
              if (!this.session) return;
              let t = (function (e, t) {
                ...
                i = cx(t),
                r = l_(
                  lA({}, cR(this.namespaces, this.optionalNamespaces)[e]),
                  { accounts: t, chains: i }
                );
              switch (e) {
                case "eip155":
                  this.rpcProviders[e] = new c0({ namespace: r });
                  break;
                case "algorand":
                  this.rpcProviders[e] = new c7({ namespace: r });
                  break;
                case "solana":
                  this.rpcProviders[e] = new c5({ namespace: r });
                  break;
                case "cosmos":
                  this.rpcProviders[e] = new c6({ namespace: r });
                  break;
                case "polkadot":
                  this.rpcProviders[e] = new cH({ namespace: r });
                  break;
                case "cip34":
                ...
                case "elrond":
                  ...
                  break;
                case "multiversx":
                  this.rpcProviders[e] = new lc({ namespace: r });
                  break;
                case "near":
                  this.rpcProviders[e] = new ld({ namespace: r });
                  break;
                case "tezos":
                  this.rpcProviders[e] = new lg({ namespace: r });
                  break;
                default:
                  this.rpcProviders[cs]
                    ? this.rpcProviders[cs].updateNamespace(r)
                    : (this.rpcProviders[cs] = new lw({ namespace: r }));
              }
            });
        }
        registerEventListeners() {
          ...
          this.client.on("session_ping", (e) => {
            ...
            this.client.on("session_event", (e) => {
              ...
              if ("accountsChanged" === s.name) {
                let e = s.data;
                e && sS(e) && this.events.emit("accountsChanged", e.map(cD));
              } else if ("chainChanged" === s.name) {
                let e = i.chainId,
                  t = i.event.data,
                  r = sv(e),
                  s = cL(e) !== cL(t) ? `${r}:${cL(t)}` : e;
            ...
            this.client.on("session_update", ({ topic: e, params: t }) => {
              ...
              (this.session = l_(lA({}, a), { namespaces: s })),
            ...
            this.client.on("session_delete", async (e) => {
              ...
              e.topic === (null == (t = this.session) ? void 0 : t.topic) &&
                ...
                this.events.emit(
                  "disconnect",
                  l_(lA({}, s_("USER_DISCONNECTED")), { data: e.topic })
                ));
            }),
        ...
        getProvider(e) {
          return this.rpcProviders[e] || this.rpcProviders[cs];
        }
        onSessionUpdate() {
        ...
        setNamespaces(e) {
          ...
          (this.optionalNamespaces = cR(t, i)),
        ...
        validateChain(e) {
          ...
          if (t && i) return [t, i];
          let r = sv(Object.keys(this.namespaces)[0]),
          ...
          try {
            ...
            let a =
              ...
              (s = null == (r = this.session) ? void 0 : r.namespaces[e])
                ...
                : s.accounts;
            if (!a) return;
            let n = a.filter((e) => e.includes(`${i}:`)).map(cD);
            if (!sS(n)) return;
        ...
        async persist(e, t) {
          ...
          await this.client.core.storage.setItem(`${ci}/${e}${r}`, t);
        }
        async getFromStore(e) {
          var t;
          let i = (null == (t = this.session) ? void 0 : t.topic) || "";
          return await this.client.core.storage.getItem(`${ci}/${e}${i}`);
        }
        async deleteFromStore(e) {
          var t;
          let i = (null == (t = this.session) ? void 0 : t.topic) || "";
          await this.client.core.storage.removeItem(`${ci}/${e}${i}`);
        }
      ...
      var lW = i(7106),
        lB = i(52303);
      let lj = (0, l$.BX)({ suggestions: [], loading: !1 }),
        lq = (0, lW.X)({
          state: lj,
          subscribe: (e) => (0, l$.B1)(lj, () => e(lj)),
          subscribeKey: (e, t) => (0, lL.u$)(lj, e, t),
          async resolveName(e) {
            try {
              return await lR.T.lookupEnsName(e);
            } catch (e) {
              throw Error(
          ...
          async isNameRegistered(e) {
            try {
              return await lR.T.lookupEnsName(e), !0;
            } catch {
              return !1;
            }
          },
          async getSuggestions(e) {
            try {
              return (
                ...
                (lj.suggestions = []),
                (lj.suggestions =
                  (await lR.T.getEnsNameSuggestions(e)).suggestions.map(
                    (e) => ({ ...e, name: e.name })
                  ) || []),
                lj.suggestions
              );
              ...
              throw Error(
                lq.parseEnsApiError(e, "Error fetching name suggestions")
              );
            } finally {
              lj.loading = !1;
            }
          ...
          async getNamesForAddress(e) {
            try {
              if (!lx.W.state.activeCaipNetwork) return [];
              let t = lD.i.getEnsFromCacheForAddress(e);
              if (t) return t;
              let i = await lR.T.reverseLookupEnsName({ address: e });
              return (
                lD.i.updateEnsCache({
                  address: e,
                  ens: i,
              ...
              throw Error(
                lq.parseEnsApiError(e, "Error fetching names for address")
              );
            }
          },
          async registerName(e) {
            let t = lx.W.state.activeCaipNetwork;
            if (!t) throw Error("Network not found");
            let i = lU.U.state.address,
            ...
            try {
              ...
              lB.I.pushTransactionStack({
                onCancel() {
                  lB.I.replace("RegisterAccountName");
                },
              });
              ...
              let o = lM.convertEVMChainIdToCoinType(Number(n));
              await lR.T.registerEnsName({
                coinType: o,
                address: i,
                signature: a,
                message: r,
              }),
                lU.U.setProfileName(e, t.chainNamespace),
                lB.I.replace("RegisterAccountNameSuccess");
            } catch (i) {
              let t = lq.parseEnsApiError(i, `Error registering name ${e}`);
              throw (lB.I.replace("RegisterAccountName"), Error(t));
            } finally {
              lj.loading = !1;
            }
          },
      ...
      let lV = {
        ...
        lX = (0, lW.X)({
          ...
          setSelectedProvider(e) {
            if (e && "meld" === e.name) {
              let t =
                  lx.W.state.activeChain === lO.o.CHAIN.SOLANA ? "SOL" : "USDC",
                i = lU.U.state.address ?? "",
                r = new URL(e.url);
              r.searchParams.append("publicKey", lF.Db),
                ...
                (lJ.selectedProvider = { ...e, url: r.toString() });
            } else lJ.selectedProvider = e;
          },
          setOnrampProviders(e) {
            Array.isArray(e) && e.every((e) => "string" == typeof e)
              ? (lJ.providers = lF.tM.filter((t) => e.includes(t.name)))
              : (lJ.providers = []);
          },
          setPurchaseCurrency(e) {
            lJ.purchaseCurrency = e;
          },
          setPaymentCurrency(e) {
            lJ.paymentCurrency = e;
          },
          setPurchaseAmount(e) {
            lX.state.purchaseAmount = e;
          },
          setPaymentAmount(e) {
            lX.state.paymentAmount = e;
          },
          async getAvailableCurrencies() {
            let e = await lR.T.getOnrampOptions();
            (lJ.purchaseCurrencies = e.purchaseCurrencies),
              (lJ.paymentCurrencies = e.paymentCurrencies),
              (lJ.paymentCurrency = e.paymentCurrencies[0] || lK),
              (lJ.purchaseCurrency = e.purchaseCurrencies[0] || lV),
              await lz.N.fetchCurrencyImages(
                e.paymentCurrencies.map((e) => e.id)
              ),
              await lz.N.fetchTokenImages(
          ...
          async getQuote() {
            lJ.quotesLoading = !0;
            try {
              let e = await lR.T.getOnrampQuote({
                purchaseCurrency: lJ.purchaseCurrency,
                paymentCurrency: lJ.paymentCurrency,
                amount: lJ.paymentAmount?.toString() || "0",
                network: lJ.purchaseCurrency?.symbol,
              });
              return (
                (lJ.quotesLoading = !1),
                (lJ.purchaseAmount = Number(e?.purchaseAmount.amount)),
                e
              );
            } catch (e) {
              return (lJ.error = e.message), (lJ.quotesLoading = !1), null;
            } finally {
              lJ.quotesLoading = !1;
            }
          },
          resetState() {
            (lJ.selectedProvider = null),
              (lJ.error = null),
              (lJ.purchaseCurrency = lV),
              (lJ.paymentCurrency = lK),
              (lJ.purchaseCurrencies = [lV]),
              (lJ.paymentCurrencies = []),
              (lJ.paymentAmount = void 0),
              (lJ.purchaseAmount = void 0),
              (lJ.quotesLoading = !1);
          },
        });
      var lY = i(37844),
      ...
      function ha(e) {
        return !!(
          ...
          (e.code === ht.YW.code ||
            e.code === ht.vx.code ||
            e.code === ht.nR.code ||
            he.A7.nodeMessage.test(e.message) ||
            5e3 === e.code)
        );
      }
      var hn = i(57561);
      let ho = {
        ConnectorExplorerIds: {
          [lO.o.CONNECTOR_ID.COINBASE]:
            "fd20dc426fb37566d803205b19bbc1d4096b248ac04548e3cfb6b3a38bd033aa",
          [lO.o.CONNECTOR_ID.COINBASE_SDK]:
            "fd20dc426fb37566d803205b19bbc1d4096b248ac04548e3cfb6b3a38bd033aa",
          [lO.o.CONNECTOR_ID.SAFE]:
            "225affb176778569276e484e1b92637ad061b01e13a048b35a9d280c3b58970f",
          [lO.o.CONNECTOR_ID.LEDGER]:
            "19177a98252e07ddfc9af2083ba8e07ef627cb6103467ffebb3f8f4205fd7927",
          [lO.o.CONNECTOR_ID.OKX]:
            "971e689d0a5be527bac79629b4ee9b925e82208e5168b733496a09c0faed0709",
          [hn.o.METMASK_CONNECTOR_NAME]:
            "c57ca95b47569778a828d19178114f4db188b89b763c899ba0be274e97267d96",
          [hn.o.TRUST_CONNECTOR_NAME]:
            "4622a2b2d6af1c9844944291e5e7351a6aa24cd7b23099efac1b2fd875da31a0",
          [hn.o.SOLFLARE_CONNECTOR_NAME]:
            "1ca0bdd4747578705b1939af023d120677c64fe6ca76add81fda36e350605e79",
          [hn.o.PHANTOM_CONNECTOR_NAME]:
            "a797aa35c0fadbfc1a53e7f675162ed5226968b44a19ee3d24385c64d1d3c393",
          [hn.o.COIN98_CONNECTOR_NAME]:
            "2a3c89040ac3b723a1972a33a125b1db11e258a6975d3a61252cd64e6ea5ea01",
          [hn.o.MAGIC_EDEN_CONNECTOR_NAME]:
            "8b830a2b724a9c3fbab63af6f55ed29c9dfa8a55e732dc88c80a196a2ba136c6",
          [hn.o.BACKPACK_CONNECTOR_NAME]:
            "2bd8c14e035c2d48f184aaa168559e86b0e3433228d3c4075900a221785019b0",
          [hn.o.BITGET_CONNECTOR_NAME]:
            "38f5d18bd8522c244bdd70cb4a68e0e718865155811c043f052fb9f1c51de662",
          [hn.o.FRONTIER_CONNECTOR_NAME]:
            "85db431492aa2e8672e93f4ea7acf10c88b97b867b0d373107af63dc4880f041",
          [hn.o.XVERSE_CONNECTOR_NAME]:
            "2a87d74ae02e10bdd1f51f7ce6c4e1cc53cd5f2c0b6b5ad0d7b3007d2b13de7b",
          [hn.o.LEATHER_CONNECTOR_NAME]:
        ...
        ConnectorImageIds: {
          [lO.o.CONNECTOR_ID.COINBASE]: "0c2840c3-5b04-4c44-9661-fbd4b49e1800",
          [lO.o.CONNECTOR_ID.COINBASE_SDK]:
            "0c2840c3-5b04-4c44-9661-fbd4b49e1800",
          [lO.o.CONNECTOR_ID.SAFE]: "461db637-8616-43ce-035a-d89b8a1d5800",
          [lO.o.CONNECTOR_ID.LEDGER]: "54a1aa77-d202-4f8d-0fb2-5d2bb6db0300",
          [lO.o.CONNECTOR_ID.WALLET_CONNECT]:
            "ef1a1fcf-7fe8-4d69-bd6d-fda1345b4400",
          [lO.o.CONNECTOR_ID.INJECTED]: "07ba87ed-43aa-4adf-4540-9e6a2b9cae00",
        },
        ConnectorNamesMap: {
          [lO.o.CONNECTOR_ID.INJECTED]: "Browser Wallet",
          [lO.o.CONNECTOR_ID.WALLET_CONNECT]: "WalletConnect",
          [lO.o.CONNECTOR_ID.COINBASE]: "Coinbase",
          [lO.o.CONNECTOR_ID.COINBASE_SDK]: "Coinbase",
          [lO.o.CONNECTOR_ID.LEDGER]: "Ledger",
          [lO.o.CONNECTOR_ID.SAFE]: "Safe",
        },
        ConnectorTypesMap: {
          [lO.o.CONNECTOR_ID.INJECTED]: "INJECTED",
          [lO.o.CONNECTOR_ID.WALLET_CONNECT]: "WALLET_CONNECT",
          [lO.o.CONNECTOR_ID.EIP6963]: "ANNOUNCED",
          [lO.o.CONNECTOR_ID.AUTH]: "AUTH",
        },
      ...
      let hl = [
        ...
        hh = {
          ...
          getChainNamespace(e) {
            return this.isCaipNetwork(e) ? e.chainNamespace : lO.o.CHAIN.EVM;
          },
          getCaipNetworkId(e) {
          ...
          extendCaipNetwork(
            ...
            return (
              c && !d.includes(c) && d.push(c),
              {
                ...
                caipNetworkId: a,
                assets: {
                  imageId: ho.NetworkImageIds[e.id],
                  imageUrl: t?.[e.id],
                },
                rpcUrls: {
                  ...e.rpcUrls,
          ...
          getViemTransport(e, t, i) {
            ...
            return (
              i?.forEach((e) => {
                r.push((0, l7.L)(e.url, e.config));
              }),
              hl.includes(e.caipNetworkId) &&
                r.push(
                  (0, l7.L)(hc(e.caipNetworkId, t), {
          ...
          extendWagmiTransports(e, t, i) {
            if (hl.includes(e.caipNetworkId)) {
              let r = this.getDefaultRpcUrl(e, e.caipNetworkId, t);
              return hs([i, (0, l7.L)(r)]);
            }
            return i;
          },
          getUnsupportedNetwork: (e) => ({
            id: e.split(":")[1],
            caipNetworkId: e,
            name: lO.o.UNSUPPORTED_NETWORK_NAME,
            chainNamespace: e.split(":")[0],
            nativeCurrency: { name: "", decimals: 0, symbol: "" },
            rpcUrls: { default: { http: [] } },
          }),
          getCaipNetworkFromStorage(e) {
            let t = lD.i.getActiveCaipNetworkId(),
              i = lx.W.getAllRequestedCaipNetworks(),
              r = Array.from(lx.W.state.chains?.keys() || []),
              s = t?.split(":")[0],
              a = !!s && r.includes(s),
      ...
      let hu = {
        ...
        hg = (0, l$.BX)({ providers: { ...hp }, providerIds: { ...hp } }),
        hf = {
          state: hg,
          subscribeKey: (e, t) => (0, lL.u$)(hg, e, t),
          subscribe: (e) =>
            (0, l$.B1)(hg, () => {
              e(hg);
            }),
          subscribeProviders: (e) =>
            (0, l$.B1)(hg.providers, () => e(hg.providers)),
          setProvider(e, t) {
            t && (hg.providers[e] = (0, l$.KR)(t));
          },
          getProvider: (e) => hg.providers[e],
          setProviderId(e, t) {
            t && (hg.providerIds[e] = t);
          },
          getProviderId(e) {
            if (e) return hg.providerIds[e];
          },
          reset() {
            (hg.providers = { ...hp }), (hg.providerIds = { ...hp });
          },
          resetChain(e) {
            (hg.providers[e] = void 0), (hg.providerIds[e] = void 0);
          },
        };
      var hm = i(60067);
      let hw = {
      ...
      let hE = {
        ...
        hC = {
          getMethodsByChainNamespace: (e) => hE[e] || [],
          ...
          createNamespaces(e, t) {
            let i = e.reduce((e, t) => {
              ...
              switch ((o.chains.push(n), n)) {
                case hb.caipNetworkId:
                  o.chains.push(hb.deprecatedCaipNetworkId);
                  break;
                case hv.caipNetworkId:
                  o.chains.push(hv.deprecatedCaipNetworkId);
              }
      ...
      class hI {
        constructor({ provider: e, namespace: t }) {
          (this.id = lO.o.CONNECTOR_ID.WALLET_CONNECT),
            (this.name =
              ho.ConnectorNamesMap[lO.o.CONNECTOR_ID.WALLET_CONNECT]),
            (this.type = "WALLET_CONNECT"),
            (this.imageId =
              ho.ConnectorImageIds[lO.o.CONNECTOR_ID.WALLET_CONNECT]),
            (this.getCaipNetworks = lx.W.getCaipNetworks.bind(lx.W)),
        ...
        async authenticate() {
          ...
          return l1.U.universalProviderAuthenticate({
      ...
      class hA {
        constructor(e) {
          (this.availableConnectors = []),
            ...
            (this.getCaipNetworks = (e) => lx.W.getCaipNetworks(e)),
            e && this.construct(e);
        }
        construct(e) {
          (this.projectId = e.projectId),
        ...
        setAuthProvider(e) {
          this.addConnector({
            id: lO.o.CONNECTOR_ID.AUTH,
            type: "AUTH",
            name: lO.o.CONNECTOR_NAMES.AUTH,
            provider: e,
            imageId: ho.ConnectorImageIds[lO.o.CONNECTOR_ID.AUTH],
        ...
        async switchNetwork(e) {
          ...
          if (r && "AUTH" === i) {
            let e = lU.U.state.preferredAccountTypes?.[t.chainNamespace];
        ...
        getWalletConnectConnector() {
          let e = this.connectors.find((e) => e instanceof hI);
      ...
      class h_ extends hA {
        ...
        async getBalance(e) {
          if (
            !(
              e.caipNetwork &&
              lF.oU.BALANCE_SUPPORTED_CHAINS.includes(
          ...
          if (
            lU.U.state.balanceLoading &&
            e.chainId === lx.W.state.activeCaipNetwork?.id
          )
            return {
              balance: lU.U.state.balance || "0.00",
              symbol: lU.U.state.balanceSymbol || "",
            };
          let t = (await lU.U.fetchTokenBalance()).find(
            (t) =>
        ...
        async signMessage(e) {
          ...
          return {
            signature:
              lx.W.state.activeCaipNetwork?.chainNamespace === lO.o.CHAIN.SOLANA
                ? (
                    await t.request(
                      {
                      ...
                      lx.W.state.activeCaipNetwork?.caipNetworkId
                    )
                  ).signature
                : await t.request(
        ...
        async switchNetwork(e) {
          ...
          if (t.chainNamespace === lO.o.CHAIN.EVM)
            try {
              await i.provider?.request({
                method: "wallet_switchEthereumChain",
                params: [{ chainId: (0, hm.nj)(t.id) }],
              });
            } catch (e) {
              if (
                e.code === hw.ERROR_CODE_UNRECOGNIZED_CHAIN_ID ||
                e.code === hw.ERROR_INVALID_CHAIN_ID ||
                e.code === hw.ERROR_CODE_DEFAULT ||
                e?.data?.originalError?.code ===
                  hw.ERROR_CODE_UNRECOGNIZED_CHAIN_ID
              )
                try {
                  await i.provider?.request({
      ...
      let hS = [
        ...
        hP = {
          email: {
            ...
            processFallback: (e) =>
              void 0 === e ? lF.oU.DEFAULT_REMOTE_FEATURES.email : !!e,
          },
          socials: {
            apiFeatureName: "social_login",
            ...
            processFallback: (e) =>
              void 0 === e
                ? lF.oU.DEFAULT_REMOTE_FEATURES.socials
                : "boolean" == typeof e
                ? !!e && lF.oU.DEFAULT_REMOTE_FEATURES.socials
                : e,
          },
          swaps: {
            apiFeatureName: "swap",
            ...
            processFallback: (e) =>
              void 0 === e
                ? lF.oU.DEFAULT_REMOTE_FEATURES.swaps
                : "boolean" == typeof e
                ? !!e && lF.oU.DEFAULT_REMOTE_FEATURES.swaps
                : e,
          },
          onramp: {
            ...
            processFallback: (e) =>
              void 0 === e
                ? lF.oU.DEFAULT_REMOTE_FEATURES.onramp
                : "boolean" == typeof e
                ? !!e && lF.oU.DEFAULT_REMOTE_FEATURES.onramp
                : e,
          },
          activity: {
            ...
            processFallback: (e) =>
              void 0 === e ? lF.oU.DEFAULT_REMOTE_FEATURES.activity : !!e,
          },
          reownBranding: {
            ...
            processApi: (e) => !!e.isEnabled,
            processFallback: (e) =>
              void 0 === e ? lF.oU.DEFAULT_REMOTE_FEATURES.reownBranding : !!e,
          },
        },
        hO = {
          ...
          processApiFeature: (e, t) => hP[e].processApi(t),
          processFallbackFeature: (e, t) => hP[e].processFallback(t),
          async fetchRemoteFeatures(e) {
            ...
            let r = null,
              s = !1;
            try {
              s = null != (r = await lz.N.fetchProjectConfig());
            } catch (e) {
              console.warn(
            ...
            let a =
              s && !t
                ? lF.oU.DEFAULT_REMOTE_FEATURES
                : lF.oU.DEFAULT_REMOTE_FEATURES_DISABLED;
            try {
              for (let e of hS) {
      ...
      class hT {
        constructor(e) {
          (this.chainNamespaces = []),
            ...
            (this.getCaipNetwork = (e, t) => {
              if (e) {
                let i = lx.W.getNetworkData(e)?.requestedCaipNetworks?.find(
                  (e) => e.id === t
                );
                if (i) return i;
                let r = lx.W.getNetworkData(e)?.caipNetwork;
                if (r) return r;
                let s = lx.W.getRequestedCaipNetworks(e);
                return s.filter((t) => t.chainNamespace === e)?.[0];
              }
              return lx.W.state.activeCaipNetwork || this.defaultCaipNetwork;
            }),
            ...
            (this.getCaipNetworks = (e) => lx.W.getCaipNetworks(e)),
            (this.getActiveChainNamespace = () => lx.W.state.activeChain),
            (this.setRequestedCaipNetworks = (e, t) => {
              lx.W.setRequestedCaipNetworks(e, t);
            }),
            (this.getApprovedCaipNetworkIds = () =>
              lx.W.getAllApprovedCaipNetworkIds()),
            (this.getCaipAddress = (e) =>
              lx.W.state.activeChain !== e && e
                ? lx.W.getAccountProp("caipAddress", e)
                : lx.W.state.activeCaipAddress),
            (this.setClientId = (e) => {
              lR.T.setClientId(e);
            }),
            (this.getProvider = (e) => hf.getProvider(e)),
            (this.getProviderType = (e) => hf.getProviderId(e)),
            (this.getPreferredAccountType = (e) =>
              lU.U.state.preferredAccountTypes?.[e]),
            (this.setCaipAddress = (e, t) => {
              lU.U.setCaipAddress(e, t),
                e && n.H.state.enableEmbedded && this.close();
            }),
            (this.setBalance = (e, t, i) => {
              lU.U.setBalance(e, t, i);
            }),
            (this.setProfileName = (e, t) => {
              lU.U.setProfileName(e, t);
            }),
            (this.setProfileImage = (e, t) => {
              lU.U.setProfileImage(e, t);
            }),
            (this.setUser = (e, t) => {
              lU.U.setUser(e, t);
            }),
            ...
            (this.setCaipNetwork = (e) => {
              lx.W.setActiveCaipNetwork(e);
            }),
            (this.setCaipNetworkOfNamespace = (e, t) => {
              lx.W.setChainNetworkData(t, { caipNetwork: e });
            }),
            (this.setAllAccounts = (e, t) => {
              lU.U.setAllAccounts(e, t),
                n.H.setHasMultipleAddresses(e?.length > 1);
            }),
            (this.setStatus = (e, t) => {
              lU.U.setStatus(e, t),
                r.a.isConnected()
                  ? lD.i.setConnectionStatus("connected")
                  : lD.i.setConnectionStatus("disconnected");
            }),
            (this.getAddressByChainNamespace = (e) =>
              lx.W.getAccountProp("address", e)),
            ...
            (this.fetchIdentity = (e) => lR.T.fetchIdentity(e)),
            (this.getReownName = (e) => lq.getNamesForAddress(e)),
            (this.getConnectors = () => r.a.getConnectors()),
            (this.getConnectorImage = (e) => lH.$.getConnectorImage(e)),
            (this.setConnectedWalletInfo = (e, t) => {
              let i = hf.getProviderId(t),
                r = e ? { ...e, type: i } : void 0;
              lU.U.setConnectedWalletInfo(r, t);
            }),
            (this.getIsConnectedState = () => !!lx.W.state.activeCaipAddress),
            (this.addAddressLabel = (e, t, i) => {
              lU.U.addAddressLabel(e, t, i);
            }),
            (this.removeAddressLabel = (e, t) => {
              lU.U.removeAddressLabel(e, t);
            }),
            (this.getAddress = (e) =>
              lx.W.state.activeChain !== e && e
                ? lx.W.getAccountProp("address", e)
            ...
            (this.setApprovedCaipNetworksData = (e) =>
              lx.W.setApprovedCaipNetworksData(e)),
            (this.resetNetwork = (e) => {
              lx.W.resetNetwork(e);
            }),
            (this.addConnector = (e) => {
            ...
            (this.setAddressExplorerUrl = (e, t) => {
              lU.U.setAddressExplorerUrl(e, t);
            }),
            (this.setSmartAccountDeployed = (e, t) => {
              lU.U.setSmartAccountDeployed(e, t);
            }),
            (this.setSmartAccountEnabledNetworks = (e, t) => {
              lx.W.setSmartAccountEnabledNetworks(e, t);
            }),
            (this.setPreferredAccountType = (e, t) => {
              lU.U.setPreferredAccountType(e, t);
            }),
        ...
        async initialize(e) {
          this.initializeProjectSettings(e),
            ...
            (this.remoteFeatures = await hO.fetchRemoteFeatures(e)),
            n.H.setRemoteFeatures(this.remoteFeatures),
            this.remoteFeatures.onramp &&
              lX.setOnrampProviders(this.remoteFeatures.onramp),
        ...
        async checkAllowedOrigins() {
          let e = await lz.N.fetchAllowedOrigins();
          if (e && a.w.isClient()) {
            let t = window.location.origin;
            hC.isOriginAllowed(t, e, hw.DEFAULT_ALLOWED_ANCESTORS) ||
              lY.h.open(l9.ALERT_ERRORS.INVALID_APP_CONFIGURATION, "error");
          } else lY.h.open(l9.ALERT_ERRORS.PROJECT_ID_NOT_CONFIGURED, "error");
        }
        ...
        initializeThemeController(e) {
          e.themeMode && lQ.W.setThemeMode(e.themeMode),
            e.themeVariables && lQ.W.setThemeVariables(e.themeVariables);
        }
        initializeChainController(e) {
          ...
          lx.W.initialize(e.adapters ?? [], this.caipNetworks, {
            connectionControllerClient: this.connectionControllerClient,
            networkControllerClient: this.networkControllerClient,
          });
          let t = this.getDefaultNetwork();
          t && lx.W.setActiveCaipNetwork(t);
        }
        ...
        initializeOptionsController(e) {
          ...
          let t = lD.i.getPreferredAccountTypes() || {},
            i = { ...n.H.state.defaultAccountTypes, ...t };
          lU.U.setPreferredAccountTypes(i);
          ...
          if (
            ...
            return void lY.h.open(
              l9.ALERT_ERRORS.PROJECT_ID_NOT_CONFIGURED,
              "error"
            );
          if (
            e.adapters?.find((e) => e.namespace === lO.o.CHAIN.EVM) &&
            e.siweConfig
          ) {
            if (e.siwx)
        ...
        setUnsupportedNetwork(e) {
          ...
          if (t) {
            let i = hh.getUnsupportedNetwork(`${t}:${e}`);
            lx.W.setActiveCaipNetwork(i);
          }
        }
        getDefaultNetwork() {
          return hh.getCaipNetworkFromStorage(this.defaultCaipNetwork);
        }
        extendCaipNetwork(e, t) {
          return hh.extendCaipNetwork(e, {
            customNetworkImageUrls: t.chainImages,
            projectId: t.projectId,
          });
        }
        extendCaipNetworks(e) {
          return hh.extendCaipNetworks(e.networks, {
        ...
        async disconnectNamespace(e) {
          try {
            let t = this.getAdapter(e),
              i = hf.getProvider(e),
              s = hf.getProviderId(e),
              { caipAddress: a } = lx.W.getAccountData(e) || {};
            this.setLoading(!0, e),
              a &&
                t?.disconnect &&
                (await t.disconnect({ provider: i, providerType: s })),
              lD.i.removeConnectedNamespace(e),
              hf.resetChain(e),
          ...
          (this.connectionControllerClient = {
            connectWalletConnect: async () => {
              ...
              this.close(),
                ...
                lD.i.setConnectedNamespaces([...lx.W.state.chains.keys()]),
                this.chainNamespaces.forEach((e) => {
                  r.a.setConnectorId(hn.o.CONNECTOR_TYPE_WALLET_CONNECT, e);
                }),
            ...
            connectExternal: async ({
              ...
              if (!d) return;
              lD.i.addConnectedNamespace(c),
                this.syncProvider({ ...d, chainNamespace: c });
              let u = lU.U.state.allAccounts,
                { accounts: p } =
                  u?.length > 0
                    ? { accounts: [...u] }
            ...
            reconnectExternal: async ({
              ...
              a?.reconnect &&
                ...
                lD.i.addConnectedNamespace(s),
                this.syncConnectedWalletInfo(s));
            },
            disconnect: async (e) => {
              let t = (function (e) {
                let t = Array.from(lx.W.state.chains.keys()),
                  i = [];
                return (
                  e
                    ? (i.push([e, lx.W.state.chains.get(e)]),
                      l8(e, lO.o.CONNECTOR_ID.WALLET_CONNECT)
                        ? t.forEach((t) => {
                            t !== e &&
                              l8(t, lO.o.CONNECTOR_ID.WALLET_CONNECT) &&
                              i.push([t, lx.W.state.chains.get(t)]);
                          })
                        : l8(e, lO.o.CONNECTOR_ID.AUTH) &&
                          t.forEach((t) => {
                            t !== e &&
                              l8(t, lO.o.CONNECTOR_ID.AUTH) &&
                              i.push([t, lx.W.state.chains.get(t)]);
                          }))
                    : (i = Array.from(lx.W.state.chains.entries())),
                  i
                );
              })(e);
              try {
            ...
            checkInstalled: (e) =>
              e
                ...
                : !!window.ethereum,
            signMessage: async (e) => {
              let t = this.getAdapter(lx.W.state.activeChain),
                i = await t?.signMessage({
                  message: e,
                  address: lU.U.state.address,
                  provider: hf.getProvider(lx.W.state.activeChain),
                });
              return i?.signature || "";
            },
            sendTransaction: async (e) => {
              let t = e.chainNamespace;
              if (lF.oU.SEND_SUPPORTED_NAMESPACES.includes(t)) {
                let i = this.getAdapter(lx.W.state.activeChain),
                  r = hf.getProvider(t),
            ...
            estimateGas: async (e) => {
              if (e.chainNamespace === lO.o.CHAIN.EVM) {
                let t = this.getAdapter(lx.W.state.activeChain),
                  i = hf.getProvider(lx.W.state.activeChain),
            ...
            getEnsAvatar: async () => (
              await this.syncIdentity({
                ...
                chainNamespace: lx.W.state.activeChain,
              }),
              lU.U.state.profileImage || !1
            ),
            getEnsAddress: async (e) => await hC.resolveReownName(e),
            writeContract: async (e) => {
              let t = this.getAdapter(lx.W.state.activeChain),
                i = this.getCaipNetwork(),
                r = this.getCaipAddress(),
                s = hf.getProvider(lx.W.state.activeChain);
              if (!i || !r)
            ...
            updateBalance: (e) => {
              ...
              t &&
                lU.U.state.address &&
                this.updateNativeBalance(lU.U.state.address, t?.id, e);
            },
          }),
        ...
        getApprovedCaipNetworksData() {
          if (
            hf.getProviderId(lx.W.state.activeChain) ===
            hn.o.CONNECTOR_TYPE_WALLET_CONNECT
          ) {
        ...
        async switchCaipNetwork(e) {
          ...
          if (this.getAddressByChainNamespace(e.chainNamespace)) {
            let i = hf.getProvider(t),
              r = hf.getProviderId(t);
            if (e.chainNamespace === lx.W.state.activeChain) {
              ...
              (this.setCaipNetwork(e), r === hn.o.CONNECTOR_TYPE_WALLET_CONNECT)
            )
        ...
        listenAdapter(e) {
          let t = this.getAdapter(e);
          if (!t) return;
          let i = lD.i.getConnectionStatus();
          "connected" === i
            ? this.setStatus("connecting", e)
            : ("disconnected" === i && lD.i.clearAddressCache(),
              this.setStatus(i, e)),
            t.on("switchNetwork", ({ address: t, chainId: i }) => {
              let r = this.getCaipNetworks().find(
                  (e) => e.id === i || e.caipNetworkId === i
                ),
                s = lx.W.state.activeChain === e,
                a = lx.W.getAccountProp("address", e);
              if (r) {
                let i = s && t ? t : a;
                i &&
                  this.syncAccount({
            ...
            t.on("accountChanged", ({ address: t, chainId: i }) => {
              ...
              r && i
                ...
                : r && lx.W.state.activeCaipNetwork?.id
                ? this.syncAccount({
                    address: t,
                    chainId: lx.W.state.activeCaipNetwork?.id,
                    chainNamespace: e,
                  })
        ...
        async syncNamespaceConnection(e) {
          try {
            e === lO.o.CHAIN.EVM &&
              a.w.isSafeApp() &&
              r.a.setConnectorId(lO.o.CONNECTOR_ID.SAFE, e);
            let t = r.a.getConnectorId(e);
            switch ((this.setStatus("connecting", e), t)) {
              case lO.o.CONNECTOR_ID.WALLET_CONNECT:
                await this.syncWalletConnectAccount();
                break;
              case lO.o.CONNECTOR_ID.AUTH:
                break;
              default:
          ...
          let e = this.chainNamespaces.map(async (e) => {
            let t = this.getAdapter(e),
              i =
                ...
                [],
              s = lx.W.state.activeCaipNetwork?.id,
              a =
                i.find((e) => {
                  let { chainId: t } = lT.parseCaipAddress(e);
                  return t === s?.toString();
                }) || i[0];
            if (a) {
              let i = lT.validateCaipAddress(a),
                { chainId: s, address: n } = lT.parseCaipAddress(i);
              if (
                (hf.setProviderId(e, hn.o.CONNECTOR_TYPE_WALLET_CONNECT),
                this.caipNetworks &&
                  lx.W.state.activeCaipNetwork &&
                  t?.namespace !== lO.o.CHAIN.EVM)
              ) {
                let i = t?.getWalletConnectProvider({
                  caipNetworks: this.getCaipNetworks(),
                  provider: this.universalProvider,
                  activeCaipNetwork: lx.W.state.activeCaipNetwork,
                });
                hf.setProvider(e, i);
              } else hf.setProvider(e, this.universalProvider);
              r.a.setConnectorId(lO.o.CONNECTOR_ID.WALLET_CONNECT, e),
                lD.i.addConnectedNamespace(e),
            ...
            this.syncConnectedWalletInfo(e),
              await lx.W.setApprovedCaipNetworksData(e);
          });
          await Promise.all(e);
        }
        syncWalletConnectAccounts(e) {
          let t = this.universalProvider?.session?.namespaces?.[e]?.accounts
            ?.map((e) => {
              let { address: t } = lT.parseCaipAddress(e);
              return t;
            })
            .filter((e, t, i) => i.indexOf(e) === t);
          t &&
        ...
        async syncAccount(e) {
          let t = e.chainNamespace === lx.W.state.activeChain,
            i = lx.W.getCaipNetworkByNamespace(e.chainNamespace, e.chainId),
            { address: r, chainId: s, chainNamespace: a } = e,
            { chainId: o } = lD.i.getActiveNetworkProps(),
            c = s || o,
            l =
              lx.W.state.activeCaipNetwork?.name ===
              lO.o.UNSUPPORTED_NETWORK_NAME,
            h = lx.W.getNetworkProp("supportsAllNetworks", a);
          if ((this.setStatus("connected", a), (!l || h) && c)) {
            ...
            if (!h && !e && !s) {
              let t = this.getApprovedCaipNetworkIds() || [],
                i = t.find(
                  (e) => lT.parseCaipNetworkId(e)?.chainId === c.toString()
                ),
                r = t.find(
                  (e) => lT.parseCaipNetworkId(e)?.chainNamespace === a
                );
        ...
        syncConnectedWalletInfo(e) {
          let t = r.a.getConnectorId(e),
            i = hf.getProviderId(e);
          if (
            i === hn.o.CONNECTOR_TYPE_ANNOUNCED ||
            i === hn.o.CONNECTOR_TYPE_INJECTED
          ) {
            if (t) {
          ...
          } else if (i === hn.o.CONNECTOR_TYPE_WALLET_CONNECT) {
            let t = hf.getProvider(e);
            t?.session &&
          ...
          } else if (t && t === lO.o.CONNECTOR_ID.COINBASE) {
            let t = this.getConnectors().find(
              (e) => e.id === lO.o.CONNECTOR_ID.COINBASE
            );
            this.setConnectedWalletInfo(
        ...
        async updateNativeBalance(e, t, i) {
          let r = this.getAdapter(i),
            s = lx.W.getCaipNetworkByNamespace(i, t);
          if (r) {
        ...
        async initializeUniversalAdapter() {
          ...
          n.H.setManualWCControl(!!this.options?.manualWCControl),
            (this.universalProvider =
              this.options.universalProvider ?? (await lP.init(t))),
        ...
        listenWalletConnect() {
          this.universalProvider &&
            ...
            this.universalProvider.on("session_event", (e) => {
              if (hC.isSessionEventData(e)) {
                let { name: t, data: i } = e.params.event;
                "accountsChanged" === t &&
                  Array.isArray(i) &&
                  a.w.isCaipAddress(i[0]) &&
                  this.syncAccount(lT.parseCaipAddress(i[0]));
              }
            }));
        }
        ...
        handleAlertError(e) {
          let [t, i] =
              Object.entries(l9.UniversalProviderErrors).find(
                ([, { message: t }]) => e.message.includes(t)
              ) ?? [],
            { message: r, alertErrorKey: s } = i ?? {};
          if (t && r && !this.reportedAlertErrors[t]) {
            let e = l9.ALERT_ERRORS[s];
            e && (lY.h.open(e, "error"), (this.reportedAlertErrors[t] = !0));
          }
        }
        getAdapter(e) {
        ...
        async open(e) {
          ...
          e?.arguments && e?.view === "Swap")
            ? l2.W.open({ ...e, data: { swap: e.arguments } })
            : l2.W.open(e);
        }
        async close() {
          await this.injectModalUi(), l2.W.close();
        }
        setLoading(e, t) {
          l2.W.setLoading(e, t);
        }
        ...
        getChainId() {
          return lx.W.state.activeCaipNetwork?.id;
        }
        async switchNetwork(e) {
          let t = this.getCaipNetworks().find((t) => t.id === e.id);
          if (!t)
            return void lY.h.open(
              l9.ALERT_ERRORS.SWITCH_NETWORK_NOT_FOUND,
              "error"
            );
          await lx.W.switchActiveNetwork(t);
        }
        getWalletProvider() {
          return lx.W.state.activeChain
            ? hf.state.providers[lx.W.state.activeChain]
            : null;
        }
        getWalletProviderType() {
          return hf.getProviderId(lx.W.state.activeChain);
        }
        subscribeProviders(e) {
          return hf.subscribeProviders(e);
        }
        getThemeMode() {
          return lQ.W.state.themeMode;
        }
        getThemeVariables() {
          return lQ.W.state.themeVariables;
        }
        setThemeMode(e) {
          lQ.W.setThemeMode(e), (0, l4.JX)(lQ.W.state.themeMode);
        }
        ...
        setThemeVariables(e) {
          lQ.W.setThemeVariables(e), (0, l4.ds)(lQ.W.state.themeVariables);
        }
        subscribeTheme(e) {
          return lQ.W.subscribe(e);
        }
        getWalletInfo() {
          return lU.U.state.connectedWalletInfo;
        }
        getAccount(e) {
          let t = r.a.getAuthConnector(e),
            i = lx.W.getAccountData(e),
            s = lx.W.state.activeChain,
            n = lD.i.getConnectedConnectorId(e || s);
          if (i)
            return {
              ...
              status: i.status,
              embeddedWalletInfo:
                t && n === lO.o.CONNECTOR_ID.AUTH
                  ? {
                      user: i.user
                        ? {
                            ...i.user,
                            username: lD.i.getConnectedSocialUsername(),
                          }
                        : void 0,
        ...
        subscribeAccount(e, t) {
          ...
          t ? lx.W.subscribeChainProp("accountState", i, t) : lx.W.subscribe(i),
            r.a.subscribe(i);
        }
        subscribeNetwork(e) {
          return lx.W.subscribe(({ activeCaipNetwork: t }) => {
            e({
              caipNetwork: t,
              chainId: t?.id,
        ...
        subscribeWalletInfo(e) {
          return lU.U.subscribeKey("connectedWalletInfo", e);
        }
        subscribeShouldUpdateToAddress(e) {
          lU.U.subscribeKey("shouldUpdateToAddress", e);
        }
        subscribeCaipNetworkChange(e) {
          lx.W.subscribeKey("activeCaipNetwork", e);
        }
        getState() {
          return l5.z.state;
        }
        subscribeState(e) {
          return l5.z.subscribe(e);
        }
        showErrorMessage(e) {
          l3.P.showError(e);
        }
        ...
        popTransactionStack(e) {
          lB.I.popTransactionStack(e);
        }
        isOpen() {
          return l2.W.state.open;
        }
        isTransactionStackEmpty() {
          return 0 === lB.I.state.transactionStack.length;
        }
        static getInstance() {
        ...
        getConnectMethodsOrder() {
          return l6.A.getConnectOrderMethod(
            n.H.state.features,
            r.a.getConnectors()
          );
        }
      ...
      class hx extends hT {
        ...
        async injectModalUi() {
          if (!hk && a.w.isClient()) {
            if (
              (await Promise.all([i.e(86), i.e(4883)]).then(i.bind(i, 4883)),
              await Promise.all([i.e(86), i.e(2589)]).then(i.bind(i, 72589)),
      ...
      function hR(e) {
        return new hx({ ...e, basic: !0, sdkVersion: "html-core-1.7.8" });
      }
    },
    47479: (e, t, i) => {
      "use strict";
...
`;
    ...
    83360: (e, t, i) => {
      ...
      o?.({ LitElement: n }), (a.litElementVersions ??= []).push("4.2.2");
    },
    84667: (e, t, i) => {
      "use strict";
      i.d(t, {
      ...
      let r = globalThis,
        ...
        g = Array.isArray,
        f = (e) => g(e) || "function" == typeof e?.[Symbol.iterator],
        m = "[ 	\n\f\r]",
        w = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
        y = /-->/g,
        b = />/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
        ...
        A = N(1),
        _ = N(2),
        S = (N(3), Symbol.for("lit-noChange")),
        P = Symbol.for("lit-nothing"),
        O = new WeakMap(),
        T = d.createTreeWalker(d, 129);
      function k(e, t) {
        if (!g(e) || !e.hasOwnProperty("raw"))
      ...
      let x = (e, t) => {
        ...
        for (let t = 0; t < i; t++) {
          ...
          for (
            ;
            p < i.length && ((n.lastIndex = p), null !== (d = n.exec(i)));
            ...
            (p = n.lastIndex),
              n === w
                ...
                ? ">" === d[0]
                  ...
                  : void 0 === d[1]
                  ? (u = -2)
                  : ((u = n.lastIndex - d[2].length),
                    (l = d[1]),
                    (n = void 0 === d[3] ? v : '"' === d[3] ? C : E))
                : n === C || n === E
                ? (n = v)
                : n === y || n === b
                ? (n = w)
                : ((n = v), (s = void 0));
          let g = n === v && e[t + 1].startsWith("/>") ? " " : "";
          a +=
            n === w
              ? i + h
              : u >= 0
              ? (r.push(l), i.slice(0, u) + o + i.slice(u) + c + g)
              : i + c + (-2 === u ? t : g);
        }
        return [
          k(
      ...
      class R {
        constructor({ strings: e, _$litType$: t }, i) {
          ...
          for (; null !== (r = T.nextNode()) && d.length < h; ) {
            if (1 === r.nodeType) {
              if (r.hasAttributes())
                for (let e of r.getAttributeNames())
                  if (e.endsWith(o)) {
                    let t = g[n++],
                      i = r.getAttribute(e).split(c),
                      a = /([.?@])?(.*)/.exec(t);
                    d.push({
                      type: 1,
                      index: s,
                    ...
                    e.startsWith(c) &&
                      (d.push({ type: 6, index: s }), r.removeAttribute(e));
              if (I.test(r.tagName)) {
                let e = r.textContent.split(c),
                  t = e.length - 1;
                if (t > 0) {
              ...
              if (r.data === l) d.push({ type: 2, index: s });
              else {
                let e = -1;
                for (; -1 !== (e = r.data.indexOf(c, e + 1)); )
                  d.push({ type: 7, index: s }), (e += c.length - 1);
              }
            s++;
          }
        }
      ...
      function U(e, t, i = e, r) {
        ...
        return (
          ...
          void 0 !== s && (t = U(e, s._$AS(e, t.values), s, r)),
          t
        );
      }
      class D {
        ...
        u(e) {
          let {
            ...
            r = (e?.creationScope ?? d).importNode(t, !0);
          T.currentNode = r;
          let s = T.nextNode(),
            a = 0,
            n = 0,
          ...
          for (; void 0 !== o; ) {
            if (a === o.index) {
              let t;
              2 === o.type
                ? (t = new $(s, s.nextSibling, this, e))
                : 1 === o.type
                ? (t = new o.ctor(s, o.name, o.strings, this, e))
                : 6 === o.type && (t = new j(s, this, e)),
                this._$AV.push(t),
                (o = i[++n]);
            }
            a !== o?.index && ((s = T.nextNode()), a++);
          }
      ...
      class $ {
          ...
          let { values: t, _$litType$: i } = e,
            r =
              "number" == typeof i
                ? this._$AC(e)
                : (void 0 === i.el &&
                    (i.el = R.createElement(k(i.h, i.h[0]), this.options)),
                  i);
        ...
        _$AC(e) {
          ...
          return void 0 === t && O.set(e.strings, (t = new R(e))), t;
        }
        k(e) {
          ...
          for (let s of e)
            r === t.length
              ? t.push(
                  (i = new $(this.O(u()), this.O(u()), this, this.options))
                )
              : (i = t[r]),
              i._$AI(s),
              r++;
      ...
      class L {
        ...
        _$AI(e, t = this, i, r) {
          let s = this.strings,
            a = !1;
          if (void 0 === s)
            (a = !p((e = U(this, e, t, 0))) || (e !== this._$AH && e !== S)) &&
              (this._$AH = e);
          else {
            let r,
              n,
            ...
            for (e = s[0], r = 0; r < s.length - 1; r++)
              (n = U(this, o[i + r], t, r)) === S && (n = this._$AH[r]),
                (a ||= !p(n) || n !== this._$AH[r]),
                n === P ? (e = P) : e !== P && (e += (n ?? "") + s[r + 1]),
                (this._$AH[r] = n);
          }
          a && !r && this.j(e);
        }
      ...
      let q = {
        ...
        H = r.litHtmlPolyfillSupport;
      H?.(R, $), (r.litHtmlVersions ??= []).push("3.3.2");
      let F = (e, t, i) => {
        let r = i?.renderBefore ?? t,
          s = r._$litPart$;
        if (void 0 === s) {
          let e = i?.renderBefore ?? null;
          r._$litPart$ = s = new $(t.insertBefore(u(), e), e, void 0, i ?? {});
        }
        return s._$AI(e), s;
      };
    },
